...
1. **`docs/STATIC-FILE-DEPLOYMENT-FIX.md`** - Technical fix documentation
2. **`docs/STATIC-DEPLOYMENT-IMPROVEMENTS.md`** - Second pass improvements
...
- `docs/STATIC-FILE-DEPLOYMENT-FIX.md` - Technical details of the fix
- `docs/STATIC-DEPLOYMENT-IMPROVEMENTS.md` - Second pass enhancements
- `docs/DOCKER-BUILD-STRATEGIES.md` - Docker deployment strategies
- `docs/DEVELOPMENT-WORKFLOW.md` - General development workflow
