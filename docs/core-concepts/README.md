...
### 1. Maintain Core Concepts Awareness

Before starting ANY task, AI assistants MUST:
1. Read `docs/README.md` (understand overall documentation structure)
2. Read `docs/core-concepts/README.md` (this file - inventory available core concepts)
3. **Identify and load ONLY relevant core concepts** for the current task
4. Keep task-relevant concepts loaded in context throughout the conversation

**Selective Loading Strategy:**
- **DON'T** read all core concepts for every task
- **DO** understand what core concepts exist (via this README)
- **DO** load applicable core concepts based on task type
- **DO** reference the task-based loading guide in copilot-instructions.md
