...
## Corpus Check
- 2411 files · ~2,139,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 20435 nodes · 39723 edges · 961 communities (695 shown, 266 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 602 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3c2ef0b`
...
- [[_COMMUNITY_test-interceptor.ts|test-interceptor.ts]]
...
- [[_COMMUNITY_1. 💀 Dead Core Modules (Superseded)|1. 💀 Dead Core Modules (Superseded)]]
...
- [[_COMMUNITY_AccessDeniedError|AccessDeniedError]]
- [[_COMMUNITY_build|build]]
...
2. `vitest` - 222 edges
3. `cn()` - 184 edges
4. `isRecord()` - 157 edges
5. `DockerRepository` - 131 edges
6. `standard` - 124 edges
7. `scripts` - 101 edges
...
## Communities (961 total, 266 thin omitted)

### Community 0 - "TypeScript Type Utilities"
Cohesion: 0.01
Nodes (390): AssertDetailedInput, AssertDetailedOutput, AssertEquals, AssertExtends, AssertHasKey, AssertInputType, AssertNotAny, AssertNotExtends (+382 more)

### Community 1 - "Mesh Networking Contracts"
Cohesion: 0.01
Nodes (209): systemMeshEventContracts, meshConnectPeerContract, meshConsumeJoinGrantContract, meshContract, meshControlEnvelopePublishContract, meshControlEnvelopePublishOps, meshDisconnectPeerContract, meshEventStreamByIdOps (+201 more)
...
Cohesion: 0.04
Nodes (34): AdminAuthConstraint, AdminMiddlewareDefinition, AdminPluginFactory, HasPermissionByRoleCheck, HasPermissionCheck, HasRoleCheck, RequireAdminRoleCheck, AnyMiddlewareDefinition (+26 more)

### Community 4 - "HTTP/Traefik Router Builder"
Cohesion: 0.06
Nodes (47): MiddlewareBuilder, CorsOptions, EntrypointConfig, IPWhiteListConfig, RateLimitConfig, VariableArray, VariableBoolean, VariableString (+39 more)
...
Cohesion: 0.04
Nodes (16): traefikServiceConfigs, CreateConfigFileInput, CreateDomainRouteInput, CreateMiddlewareInput, CreateServiceConfigInput, CreateServiceTargetInput, CreateSSLCertificateInput, HealthStatus (+8 more)

### Community 7 - "Permission & Role Checks"
Cohesion: 0.03
Nodes (88): ORPCContextWithAuth, ORPCContextWithAuthBrand, ORPCContextWithAuthOnly, AdminAuthConstraint, AdminPluginFactory, HasPermissionByRoleCheck, HasPermissionCheck, HasRoleCheck (+80 more)

### Community 8 - "Docker Container Inspection"
Cohesion: 0.04
Nodes (45): cancelEnvelopeSchema, correlationInputSchema, dockerContainerInspectQuerySchema, DockerContainerInspectRequestPayload, DockerContainerInspectResponsePayload, dockerContainerInspectResponsePayloadSchema, DockerContainerListMeta, dockerContainerListMetaSchema (+37 more)

### Community 9 - "Mesh Core & Orchestration"
Cohesion: 0.04
Nodes (71): SystemMeshEventService, Injectable, MESH_TOPIC_SERVICES, MESH_TOPOLOGY_SERVICES, StubMeshNodeCaller, MeshRuntimeModule, Module, MeshConfigTrustKeys (+63 more)

### Community 10 - "Docker Container Actions"
Cohesion: 0.04
Nodes (90): dockerContainerActionsContract, dockerContainerCreateDirectoryContract, dockerContainerCreateDirectoryOps, dockerContainerDeletePathContract, dockerContainerDeletePathOps, dockerContainerFilesystemContract, dockerContainerFilesContract, dockerContainerFilesOps (+82 more)

### Community 11 - "Docker Module Wiring"
Cohesion: 0.06
Nodes (30): DockerNetworksOrchestratorService, Injectable, DockerNetworksDomainService, Injectable, DockerRegistriesOrchestratorService, Injectable, DockerRegistriesDomainService, Injectable (+22 more)

### Community 12 - "Mesh Topology Services"
Cohesion: 0.06
Nodes (11): MeshClusterSyncService, Injectable, MeshMembershipReconcileInput, MeshMembershipReconcileResult, MeshQueuePartitionPlanInput, MeshQueuePartitionPlanResult, MeshPeerConnection, MeshPeerHeartbeatInput (+3 more)

### Community 13 - "Docker Runtime Activity Projection"
Cohesion: 0.04
Nodes (93): DockerKnownSource, DockerRawEvent, RuntimeEventFieldFilter, RuntimeEventFilterNode, StreamQuery, DockerRuntimeSystemEvent, dockerContainerEntitySchema, dockerContainerRuntimeEventSchema (+85 more)

### Community 14 - "Mesh Cluster Repository"
Cohesion: 0.06
Nodes (38): MeshOpenInternalBridgeInput, streamFields, makeFieldRef(), MeshFieldKey, MeshFieldMap, MeshFieldRef, meshFieldRefSymbol, meshFields() (+30 more)

### Community 15 - "Deployment Pipeline Service"
Cohesion: 0.03
Nodes (81): BASE_PHASE_TRANSITIONS, BASE_RETRY_POLICIES, CANCELLABLE_STATUSES, TODO: Queue retry job via orchestration module (not yet migrated), StreamEventWithMeta, StreamReplayInput, deploymentCompilePlanContract, deploymentCompilePlanPreviewContract (+73 more)

### Community 16 - "hooks.ts"
Cohesion: 0.03
Nodes (101): coerceContainerLogEntry(), CONTAINER_METRICS_STREAM_ACTIONS, debugDockerModalLogs, DockerContainerDetailModalContent(), DockerContainerDetailModalContentProps, DockerContainerDetailModalTriggerProps, DockerTerminalSessionState, extractContainerLogEntries() (+93 more)

### Community 17 - "cn"
Cohesion: 0.04
Nodes (78): DataTableResizer(), ExpandIcon(), ExpandIconProps, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+70 more)

### Community 18 - "SystemMeshTopologyService"
Cohesion: 0.03
Nodes (63): MeshEntity, MeshOperation, BaseMeshService(), BaseMeshServiceConstructor, buildEntityOperationContracts(), getEntityOperations(), getEntityQueries(), MeshCallManyMetrics (+55 more)

### Community 19 - "types.ts"
Cohesion: 0.08
Nodes (40): BASE_STATUS, createDefaultServiceConfig(), createExecutionOverrides(), createProviderConfig(), createRunnerConfig(), createStatusMap(), PROFILE_OVERRIDES, resolveProviderType() (+32 more)

### Community 20 - "index.ts"
Cohesion: 0.05
Nodes (36): serviceDomainMappings, verificationMethodEnum, verificationStatusEnum, BasePathValidationResult, SubdomainAvailabilityResult, SubdomainConflict, SubdomainValidationResult, InsertOrganizationDomain (+28 more)

### Community 21 - "index.ts"
Cohesion: 0.03
Nodes (95): assertClaimedByWorker(), parseClaimResult(), parseDeadLetterJob(), parseDeadLetterListResult(), parseDeadLetterReplayResult(), parseEnqueueResult(), parseHeartbeatResult(), parseQueueJob() (+87 more)
...
Cohesion: 0.04
Nodes (27): createBetterAuth(), AuthModuleOptions, AuthWithPlugins, { ConfigurableModuleClass, OPTIONS_TYPE, ASYNC_OPTIONS_TYPE }, MODULE_OPTIONS_TOKEN, PermissionApiExtras, WithPermissionApis, AuthContextErrorMap (+19 more)

### Community 24 - "platform-domain.builder.ts"
Cohesion: 0.05
Nodes (48): DependencyAttachmentMode, dependencyAttachmentModeSchema, DependencyEnvironmentDiffStatus, dependencyEnvironmentDiffStatusSchema, DependencyFailureMode, dependencyFailureModeSchema, DependencyHealthGate, dependencyHealthGateSchema (+40 more)

### Community 25 - "index.ts"
Cohesion: 0.02
Nodes (90): ConfigFile, configFiles, configFileSchema, configFilesRelations, CreateConfigFile, createConfigFileSchema, CreateDomainConfig, createDomainConfigSchema (+82 more)
...
Cohesion: 0.10
Nodes (18): FieldFilterConfig, ComputeInputSchema, ComputeMetaSchema, ComputeOutputSchema, ExtractFieldType, ExtractOperators, ExtractPaginationConfig, ExtractSchemaFromFilterField (+10 more)

### Community 30 - "DockerRuntimeRunnerService"
Cohesion: 0.07
Nodes (34): DelegatedRuntimeRunnerBase, BuildpackRunnerOptions, buildpackRunnerOptionsSchema, DockerComposeRunnerOptions, dockerComposeRunnerOptionsSchema, DockerfileRunnerOptions, dockerfileRunnerOptionsSchema, NixpacksRunnerOptions (+26 more)
...
Cohesion: 0.08
Nodes (18): DeploymentStateMachineScopeConfigInput, DeploymentModule, Module, DeploymentStreamBridgeService, Injectable, DeploymentStreamOrchestratorService, OpenDeploymentStreamInput, Injectable (+10 more)

### Community 33 - "stream.ts"
Cohesion: 0.03
Nodes (81): deploymentCancelExecutionContract, deploymentExecutionCancelOps, deploymentExecutionCheckpointByRunOps, deploymentExecutionCheckpointOps, deploymentExecutionResumeOps, deploymentGetExecutionCheckpointByRunContract, deploymentGetExecutionCheckpointContract, deploymentResumeExecutionContract (+73 more)
...
Cohesion: 0.05
Nodes (43): dockerRuntimeActivities, dockerRuntimeActivityCategoryEnum, dockerRuntimeActivitySeverityEnum, dockerRuntimeActivityStatusEnum, dockerImageLifecycleStateEnum, dockerImageSecurityLifecycle, dockerImageSecurityScanHistory, dockerImageSecurityScans (+35 more)

### Community 37 - "docker-entity-domain.service.ts"
Cohesion: 0.07
Nodes (25): DockerEntityCacheService, DockerEntityFlatKindPayload, DockerEntityKindPayload, Injectable, DockerEntityDomainService, EntityFilterInput, InspectKindResult, KINDS_WITH_FLAT_LIST (+17 more)

### Community 38 - "index.ts"
Cohesion: 0.05
Nodes (48): CreateAdminMiddlewareOptions, CreateAdminMiddlewareOptions, AdminPlugin, AdminPluginInstance, AdminPluginWrapperOptions, ApiMethodsWithAdminPlugin, AuthWithAdminPlugin, NOTE: Uses only TPermissionBuilder as generic parameter - TStatement and TRoles (+40 more)

### Community 39 - "BaseEventService"
Cohesion: 0.05
Nodes (6): BaseEventMergeBuilder, BaseEventService, EventLogPersistenceAdapter, TestEventService, DxEventService, TypedDeploymentEventService

### Community 40 - "ProjectService"
Cohesion: 0.04
Nodes (29): runtimeConfigurationAccessor, ProjectController, TODO: trigger actual health check, Controller, Implement, ProjectRepository, transformCollaborator(), transformEnvironment() (+21 more)

### Community 41 - "middlewares.ts"
Cohesion: 0.06
Nodes (29): ORPCGlobalContext, Auth, AuthUtils, AuthUtilsEmpty, buildMeshContext(), parseParcour(), readEnv(), resolveSharedSecret() (+21 more)

### Community 42 - "index.ts"
Cohesion: 0.05
Nodes (73): deploymentEnvironmentSchema, DockerContainerHealth, dockerContainerHealthSchema, DockerContainerStatus, dockerContainerStatusSchema, DockerListMeta, dockerListMetaSchema, DockerContainerManagedBy (+65 more)
...
Cohesion: 0.06
Nodes (40): DockerImageCatalogRepository, Injectable, dockerEntityContract, dockerEntityInspectContract, dockerEntityInspectOps, DockerEntityInspectResponse, dockerEntityInspectResponseSchema, dockerEntityListContract (+32 more)

### Community 45 - "index.ts"
Cohesion: 0.11
Nodes (33): DockerStack, dockerStackSchema, DockerStackServiceRef, dockerStackServiceRefSchema, DockerStackStatus, dockerStackStatusSchema, DockerStackActivityEntry, dockerStackActivityEntrySchema (+25 more)

### Community 46 - "CoreEventSyncService"
Cohesion: 0.06
Nodes (22): coreEventLogs, coreEventStreams, coreEventStreamsRelations, CoreEventLogPersistInput, CoreEventLogRecord, CoreEventStreamRepository, CoreEventStreamRow, toDto() (+14 more)

### Community 47 - "LocalDatabaseService"
Cohesion: 0.08
Nodes (19): test(), bootstrap(), CLIModule, MigrateCommand, Command, Injectable, ResetCommand, Command (+11 more)

### Community 48 - "permission-engine.ts"
Cohesion: 0.11
Nodes (23): PermissionService, ctx, mockEngine, orgRoleRule, rule, Injectable, ColumnResolver, buildDynamicVars() (+15 more)

### Community 49 - "VariableRegistry"
Cohesion: 0.06
Nodes (3): VariableRegistry, Variable, VariableType

### Community 50 - "deployment-queue-lifecycle.service.ts"
Cohesion: 0.06
Nodes (32): createDeploymentQueueWorkflowContext(), DeploymentQueueLifecyclePort, DeploymentBullEnqueueInput, deploymentBullEnqueueInputSchema, DeploymentBullEnqueueOutput, deploymentBullEnqueueOutputSchema, DeploymentBullJobData, DeploymentBullJobName (+24 more)

### Community 51 - "context-filter-debug.ts"
Cohesion: 0.06
Nodes (53): revalidateAllAction(), SignOutButton(), ContextFilterDebugLogger, ContextFilterDebugPredicate, createContextFilterDebugLogger(), WEB_CONTEXT_FILTER_VALUE, webLogger, toAbsoluteUrl() (+45 more)
...
Cohesion: 0.11
Nodes (17): DockerRuntimeActivityDomainService, Injectable, DockerRuntimeOrchestratorService, Injectable, dockerRuntimeActivityDetailContract, dockerRuntimeActivityDetailOps, DockerRuntimeActivityDetailQueryInput, dockerRuntimeActivityDetailQuerySchema (+9 more)

### Community 54 - "index.ts"
Cohesion: 0.07
Nodes (59): TemplateCompatibilityMatrix, TemplateCompatibilityMatrixItem, templateCompatibilityMatrixItemSchema, TemplateCompatibilityValidationInput, TemplateCompatibilityValidationResult, BuildTemplateConfig, buildTemplateConfigSchema, dependencyTemplateConfigSchema (+51 more)

### Community 55 - "index.ts"
Cohesion: 0.06
Nodes (67): createZodListOptions(), ALL_FILTER_OPERATORS, ARRAY_OPERATORS, arrayField(), booleanField(), COMPARISON_OPERATORS, comparisonField(), createFieldFilterSchema() (+59 more)

### Community 56 - "core-event-sync.service.ts"
Cohesion: 0.02
Nodes (95): AnyEventEmission, BASE_EVENT_SERVICE_SYMBOL, BaseEventServiceRegistryEntry, BaseEventServiceSymbolized, BufferedEventRecord, EventSubscription, EventSubscriptionData, MergedDomainEventEnvelope (+87 more)

### Community 57 - "DockerRuntimeEventsSourceService"
Cohesion: 0.05
Nodes (33): DockerContainerRuntimeEventsService, Injectable, DockerDomainRuntimeEventsService, Injectable, DockerRuntimeEventsSourceService, Injectable, DockerImageRuntimeEventsService, Injectable (+25 more)

### Community 58 - "index.ts"
Cohesion: 0.05
Nodes (53): createAdminMiddleware(), createOrganizationMiddleware(), AnyMiddlewareContext, AuthConstraint, CheckResult, ContextResolver, createAuthError(), createPermissionError() (+45 more)
...
Cohesion: 0.05
Nodes (8): authMiddleware(), requireAuth(), requireMesh(), requirePlatformRole(), DeploymentController, DockerController, Controller, Implement

### Community 61 - "docker-container-runtime-mesh.service.ts"
Cohesion: 0.03
Nodes (74): cancelEnvelopeSchema, containerCreateDirectoryBodySchema, containerDeletePathBodySchema, containerFilesQuerySchema, containerFilesSnapshotSchema, containerLogsQuerySchema, containerLogsSnapshotSchema, containerMutationAckSchema (+66 more)
...
Cohesion: 0.04
Nodes (11): DOCKER_NETWORK_DRIVERS, DOCKER_NETWORK_SCOPES, DockerRepository, ScannerExecutionProgressOptions, ScannerRunProgressOptions, ScannerKind, Injectable, DockerImageScanFindingEntry (+3 more)
...
### Community 66 - "cn"
Cohesion: 0.08
Nodes (38): Props, StepIndicator(), Button(), buttonVariants, Command(), CommandDialog(), CommandEmpty(), CommandGroup() (+30 more)

### Community 67 - "page.tsx"
Cohesion: 0.07
Nodes (52): CreateOrganizationPage(), localOrganizationSchema, ProvisioningMode, remoteConnectSchema, AdminSystemPage(), MeshLookupHistoryEntry, MeshRoutePlanHistoryEntry, fleetEndpoints (+44 more)

### Community 68 - "InitializationService"
Cohesion: 0.04
Nodes (20): MeshContract, publicAccess(), MeshInitializationModule, Module, MeshBootstrapConfig, MeshInitializationService, MeshSetupSession, MeshVersionService (+12 more)

### Community 69 - "BaseTriggerService"
Cohesion: 0.06
Nodes (26): AppModule, createResultBridge(), BridgeResult, SUB_APP_RESULT(), store, SubAppResultStore, logger, SubAppRunner (+18 more)

### Community 70 - "isObjectLike"
Cohesion: 0.09
Nodes (55): s, CONFIG_SYMBOL, ObjectSchema, SchemaWithConfig, withConfig(), comparisonField(), createFieldFilterSchema(), createFilteringConfigSchema() (+47 more)

### Community 71 - "index.ts"
Cohesion: 0.09
Nodes (17): redirect(), mocks, SignInPageLoose, loginSchema, signupSchema, mocks, SetupPageLoose, SetupWizard() (+9 more)

### Community 72 - "index.ts"
Cohesion: 0.04
Nodes (78): MESH_ERROR_CODES, MESH_ERROR_HTTP_STATUS, MESH_ERROR_ORPC_CODE, meshDomainErrorContracts(), MeshDomainErrorPayload, meshDomainErrorPayloadSchema, MeshErrorCode, MeshErrorResponse (+70 more)

### Community 73 - "common.ts"
Cohesion: 0.04
Nodes (56): nest-commander, pg, logger, SetupDbCommand, SetupDbOptions, AuthModule, HOOKS, createAuthMiddleware() (+48 more)
...
Cohesion: 0.04
Nodes (24): CliAuthContext, CliAuthMethod, IMPORTANT: This method creates the user directly in the database (not via admin, deploymentCache, imageProjectMembership, projectScanConfig, localBuildCache, localEventOutbox (+16 more)
...
Cohesion: 0.03
Nodes (71): AuthWithPlugins, AuthUtils, AuthUtilsEmpty, createAuthMiddleware(), ORPCContextWithAuth, ORPCContextWithAuthOnly, publicAccess(), readEnv() (+63 more)
...
Cohesion: 0.05
Nodes (30): DeploymentCoreModule, Module, PreviewCleanupDecision, PreviewCleanupPolicyService, PreviewCleanupTrigger, Injectable, PreviewNamingInput, PreviewNamingResult (+22 more)
...
Cohesion: 0.08
Nodes (25): DomainError, DomainAlreadyExistsError, DomainDeletionError, DomainNotVerifiedError, GranularityViolationError, InvalidDomainFormatError, OrganizationDomainNotFoundError, ProjectDomainAlreadyExistsError (+17 more)
...
Cohesion: 0.06
Nodes (11): MeshTopicEnvelopeHandlerService, Injectable, MeshEnvelopeSideEffectsService, Injectable, MeshTrustService, Injectable, MeshControlEnvelope, MeshTrustKey (+3 more)

### Community 88 - "index.ts"
Cohesion: 0.06
Nodes (29): ValidationIssue, ConfigBuildError, ConfigNotFoundError, ConfigSyncError, ConfigValidationError, TraefikError, DirectoryError, FileDeleteError (+21 more)

### Community 89 - "standard-schema-helpers.ts"
Cohesion: 0.03
Nodes (64): createPathParamBuilder(), ExtractPathParams, ParamsToSchemaShape, PathParam, PathParamBuilder, PathParamBuilderWithExisting, SchemaShape, ProxyBuilderBase (+56 more)
...
Cohesion: 0.04
Nodes (33): createOutputFn(), ErrorDefinitionBuilder, ExtractErrorFromBuilder, ExtractErrorsFromBuilders, CompactDetailedInputShape, CurrentDetailedInputParts, CurrentInputBody, CurrentInputHeaders (+25 more)

### Community 93 - "index.ts"
Cohesion: 0.07
Nodes (51): ClientSessionInjectedProps, ComponentWithDisplayName, CoreRouteElements, DeleteRouteBuilder, emptySchema, FetchOptions, GetRouteBuilder, LinkProps (+43 more)

### Community 94 - "mesh-entity.ts"
Cohesion: 0.04
Nodes (49): nodeInfoEntity, AnyMeshEntity, BoundEntityMutations, BoundEntityQueries, BoundMeshMutation, BoundMeshQuery, getEventTypes(), MeshEntity (+41 more)

### Community 95 - "deployment.ts"
Cohesion: 0.02
Nodes (97): apiKeysRelations, deploymentEnvironmentEnum, deploymentLogs, deploymentLogsRelations, deploymentPhaseEnum, deploymentRollbacks, deploymentRollbacksRelations, deploymentRules (+89 more)
...
Cohesion: 0.08
Nodes (38): ServiceConfigSubNav(), sectionLabel, sectionRoute, ServiceSection, ServiceSectionNav(), ServiceSectionNavProps, DashboardServiceConfigurationEnvironmentPage(), DashboardServiceConfigurationNetworkPage() (+30 more)

### Community 98 - "standard-operations.ts"
Cohesion: 0.08
Nodes (29): EntityOperationOptions, ListOperationOptions, ListPlainOptions, StandardOperations, standard, userSchema, validCreateUser, validUser (+21 more)
...
Cohesion: 0.06
Nodes (45): ColumnOrderUpdater, DataFetchParams, DataFetchResult, DataTable(), PaginationUpdater, RowSelectionUpdater, SortingUpdater, SubRowsConfig (+37 more)
...
### Community 107 - ".error"
Cohesion: 0.07
Nodes (4): DockerService, Injectable, ScannerContainerManagerService, Injectable
...
Cohesion: 0.06
Nodes (44): Route, convertURLSearchParamsToObject(), PushOptions, usePush(), useSearchParams(), BasePageProps, CoreRouteElements, createRouteBuilder() (+36 more)
...
Cohesion: 0.04
Nodes (42): DeploymentBuilderKind, deploymentBuilderKindSchema, DeploymentEnvironment, deploymentEnvironmentSchema, DeploymentExecutionStateMachineInput, deploymentExecutionStateMachineInputSchema, DeploymentExecutionStateMachineResolution, DeploymentExecutionStateMachineViolation (+34 more)

### Community 117 - "ServiceService"
Cohesion: 0.08
Nodes (11): ProjectAccessService, Injectable, ServiceController, Controller, Implement, ServiceEventService, Injectable, ServiceService (+3 more)
...
Cohesion: 0.19
Nodes (4): defaultOrpcContextBuilder(), DockerContainerMetricsStreamService, Injectable, isRecord()

### Community 121 - "InternalErrorInsightService"
Cohesion: 0.05
Nodes (29): getInternalErrorRequestContext(), INTERNAL_ERROR_CONTEXT_KEY, InternalErrorRequestContext, InternalErrorContextMiddleware, Injectable, RequestWithInternalErrorContext, setInternalErrorRequestContext(), InternalErrorExceptionFilter (+21 more)
...
Cohesion: 0.07
Nodes (30): templateCreateContract, templateOps, templateDeleteContract, templateOps, templateFindByIdContract, templateOps, templateContract, templateListConfig (+22 more)
...
Cohesion: 0.06
Nodes (21): createGatewayCatchAll(), handleProxy(), GatewayService, proxyRequest(), RouteRegistryService, HttpMethod, RouteEntry, RoutePattern (+13 more)

### Community 127 - "docker-runtime-stream-orchestrator.service.ts"
Cohesion: 0.09
Nodes (15): DockerRuntimeEventsStreamService, Injectable, DockerRuntimeMeshRelayService, Injectable, DockerKnownSource, InspectTrigger, InspectTriggerOrigin, RuntimeEventFieldFilter (+7 more)
...
Cohesion: 0.09
Nodes (6): CompleteServiceConfig, MiddlewareData, SyncResult, SyncSummary, TraefikSyncService, Injectable

### Community 130 - "auth-module-definition.ts"
Cohesion: 0.09
Nodes (17): AuthModule, Inject, Module, AuthModuleOptions, { ConfigurableModuleClass, OPTIONS_TYPE, ASYNC_OPTIONS_TYPE }, MODULE_OPTIONS_TOKEN, PermissionApiExtras, WithPermissionApis (+9 more)
...
Cohesion: 0.10
Nodes (14): DockerContainerLogsSnapshot, DockerContainerLogsSnapshotRequestPayload, DockerContainerProcessesSnapshot, DockerContainerProcessesSnapshotRequestPayload, DockerContainerProcessLogsSnapshotRequestPayload, DockerContainerLogsDomainService, Injectable, DockerContainerProcessesTabProps (+6 more)

### Community 134 - "setup-wizard.tsx"
Cohesion: 0.15
Nodes (12): defaultLabels, initialState, localLabels, remoteLabels, WizardState, WizardStep, getDescription(), getHeading() (+4 more)

### Community 135 - "helpers.ts"
Cohesion: 0.03
Nodes (44): meshInvalidations, projectEndpoints, enhancedProject, ProjectEndpoints, projectInvalidations, projectInvalidationsConfig, BetterAuthError, buildInvalidationProxy() (+36 more)
...
Cohesion: 0.10
Nodes (5): DockerRuntimeStreamOrchestratorService, Injectable, DockerContainerInspectStreamQueryInput, DockerImageInspectStreamQueryInput, DockerRuntimeEvent
...
Cohesion: 0.13
Nodes (17): DetailedInputBuilderSchema, createLiveQueryHook(), createMutationHook(), createQueryHook(), createStreamedQueryHook(), ExtractInput, ExtractMutationInput, ExtractMutationOutput (+9 more)

### Community 142 - "platform-domain.schema.ts"
Cohesion: 0.05
Nodes (42): cacheStrategyEnum, deploymentCacheRelations, deploymentStrategyEnum, githubApps, githubAppsRelations, githubDeploymentRules, githubDeploymentRulesRelations, githubPreviewDeployments (+34 more)
...
Cohesion: 0.04
Nodes (55): createDeploymentCompleteStrategyContext(), DeploymentCompleteStrategyContext, seedTestOwner(), RuntimeCase, collectStreamEvents(), runRemoteSetup(), runSetup(), SetupEvent (+47 more)
...
Cohesion: 0.11
Nodes (33): ContainerStreamEntity, debugContainerLogsStream, resolveFallbackPayloadMessage(), useContainerStreamLogs(), debugDockerLogsFilter, useFilteredLogs(), UseFilteredLogsParams, usePersistedLogGroups() (+25 more)
...
Cohesion: 0.10
Nodes (20): account, accountRelations, invitation, invitationRelations, memberRelations, organizationRelations, organizationRole, organizationRoleRelations (+12 more)

### Community 149 - "organization.repository.ts"
Cohesion: 0.09
Nodes (22): user, OrganizationController, Controller, Implement, OrganizationRepository, Injectable, OrganizationService, Injectable (+14 more)

### Community 150 - "page.tsx"
Cohesion: 0.13
Nodes (19): cloneValue(), DashboardProjectEnvironmentDetailsPage(), DEPENDENCY_HEALTH_OPTIONS, DEPENDENCY_REQUIREMENT_OPTIONS, DEPENDENCY_STARTUP_OPTIONS, DependencyHealthGate, DependencyRequirement, DependencyStartup (+11 more)
...
Cohesion: 0.10
Nodes (29): serviceCreateContract, serviceCreateInputSchema, serviceDeleteContract, serviceFindByIdContract, serviceCrudContract, serviceObjectSchema, serviceOps, serviceUpdateContract (+21 more)

### Community 154 - "page.tsx"
Cohesion: 0.08
Nodes (33): DockerImageDetailModalTrigger(), ContainerColumnsDeps, ContainerInstanceProjection, ContainerProjection, ContainerTableFetchParams, ContainerTableRow, createContainerColumns(), createContainerTableFetchData() (+25 more)

### Community 155 - "index.ts"
Cohesion: 0.15
Nodes (16): formatDate(), getInitials(), ProfileForm(), ProfileFormProps, AuthDashboardProfile, CachedUser, createMasterSession(), extractDevAuthKey() (+8 more)
...
Cohesion: 0.11
Nodes (10): ConfigurationLifecycleState, ConfigurationProviderType, ConfigurationRunnerType, RuntimeConfigurationStateMachine, runtimeConfigurationStateMachineSchema, RuntimeConfigurationStateNodeInput, ConfigurationStateMachineBuilderService, RuntimeConfigurationPolicyDsl (+2 more)
...
Cohesion: 0.04
Nodes (49): FunctionContext, toAdvancedUseQuery(), toAdvancedUseSuspenseQuery(), toUseMutation(), toUseQuery(), toUseSuspenseQuery(), transformUseReturn(), keysToSnake() (+41 more)
...
Cohesion: 0.15
Nodes (16): ApiBearerAuth, ApiOperation, ApiParam, ApiResponse, ApiTags, assertAuthenticated(), TestController, AllowAnonymous (+8 more)

### Community 167 - "docker-containers-orchestrator.service.ts"
Cohesion: 0.08
Nodes (17): DockerContainerCreateDirectoryRequestPayload, DockerContainerDeletePathRequestPayload, DockerContainerReadFileSnapshotRequestPayload, DockerContainerRenamePathRequestPayload, DockerContainerWriteFileRequestPayload, DockerContainersOrchestratorService, DockerTerminalStreamEvent, Injectable (+9 more)

### Community 168 - "docker-container-runtime.service.ts"
Cohesion: 0.12
Nodes (13): DockerContainerTerminalCloseRequestPayload, DockerContainerTerminalInputRequestPayload, DockerContainerTerminalOpenRequestPayload, TerminalSessionEvent, TerminalSessionStoredEvent, TerminalSessionStream, DockerContainerShellDomainService, DockerTerminalStreamEvent (+5 more)

### Community 169 - "hooks.ts"
Cohesion: 0.10
Nodes (31): AdminInvitesPage(), AdminMembersPage(), AdminOrganizationDetailPage(), AdminSettingsPage(), getMembersArray(), isOrganizationRoleAtLeast(), RequireOrganizationRole(), RequireOrganizationRoleProps (+23 more)

### Community 170 - ".key"
Cohesion: 0.08
Nodes (6): MeshResourceBuilder, compareHlc(), Hlc, LwwEntry, LwwMap, OrSet
...
Cohesion: 0.10
Nodes (12): ADVANCED_FILTER_FIELDS, ADVANCED_FILTER_OPERATORS, AdvancedFilterField, AdvancedFilterLogic, AdvancedFilterOperator, AdvancedServiceFilterRule, DependencyRoutePreview, describeAdvancedRule() (+4 more)
...
Cohesion: 0.04
Nodes (52): dockerRuntimeCatalogOps, dockerRuntimeSnapshotContract, projectDeploymentConfigOps, projectGetDeploymentConfigContract, projectDeploymentConfigOps, projectDeploymentConfigUpdateInputSchema, projectUpdateDeploymentConfigContract, projectEnvironmentConfigOps (+44 more)

### Community 176 - "peerDependencies"
Cohesion: 0.05
Nodes (36): dependencies, @repo/type-guards, devDependencies, @repo/config-typescript, @types/bun, @types/express, @types/node, @typescript/native-preview (+28 more)
...
Cohesion: 0.08
Nodes (33): ContractProcedureMetadata, detectOperationType(), isEventIteratorOutput(), OperationType, defineInvalidations(), reactQueryMocks, getObservableSchemaDetails(), createRouteMethodMeta() (+25 more)
...
Cohesion: 0.21
Nodes (18): OrganizationResource, OrganizationRole, createRequirePermissionComponents(), PermissionTarget, RequireOrganizationPermissionProps, RequirePermissionProps, RequirePlatformPermissionProps, createPermissionHooks() (+10 more)
...
Cohesion: 0.07
Nodes (34): AuthInstance, createAuthClientFactory(), CreateAuthClientFactoryOptions, AdminClientPlugin, InviteClientPlugin, OrganizationClientPlugin, useAdminClient(), useInviteClient() (+26 more)
...
Cohesion: 0.12
Nodes (11): ProviderTraefikTemplate, providerTraefikTemplates, ServiceTraefikTemplate, serviceTraefikTemplates, TemplateVariables, TraefikTemplateRepository, Injectable, TraefikTemplateService (+3 more)
...
Cohesion: 0.04
Nodes (54): projectGetCollaboratorsContract, projectInviteCollaboratorContract, projectRemoveCollaboratorContract, projectCollaboratorInviteOps, projectCollaboratorOps, projectCollaboratorParamsSchema, projectIdParamSchema, projectUpdateCollaboratorContract (+46 more)

### Community 203 - "docker.mock.ts"
Cohesion: 0.07
Nodes (26): MOCK_DOCKER_CONTAINERS, MOCK_DOCKER_DEPLOYMENTS, MOCK_DOCKER_FLEET_SERVERS, MOCK_DOCKER_IMAGES, MOCK_DOCKER_IMAGES_ENTITIES, MOCK_DOCKER_LOG_LINES, MOCK_DOCKER_MESH_EVENT_STREAMS, MOCK_DOCKER_MESH_STATE (+18 more)
...
Cohesion: 0.13
Nodes (31): buildNuqsParserMap(), buildSchemaDefaults(), createFallbackParser(), createParserForSchema(), emptySchema, extractObjectShape(), extractSchemaDefaultValue(), getInnerSchema() (+23 more)
...
Cohesion: 0.10
Nodes (14): webhooks, ProjectModule, Module, Injectable, WebhookCreateInput, WebhookRepository, WebhookRow, WebhookUpdateInput (+6 more)
...
Cohesion: 0.03
Nodes (83): domainContract, addOrganizationDomainContract, deleteOrganizationDomainContract, deleteOrganizationDomainInput, deleteOrganizationDomainOutput, getOrganizationDomainContract, getOrganizationDomainInput, listOrganizationDomainsContract (+75 more)
...
Cohesion: 0.11
Nodes (24): asWrapper(), compileDFilter(), compileOperator(), resolveVar(), ProjectSchema, sqlAnd(), sqlOr(), matchFilter() (+16 more)
...
Cohesion: 0.06
Nodes (33): main(), collectStreamEvents(), runLocalSetup(), SetupResult, SetupStreamEvent, collectStreamEvents(), runLocalSetup(), SetupResult (+25 more)
...
Cohesion: 0.10
Nodes (26): CapabilityStatus, platformCapabilities, PlatformCapability, addTimingEntry(), clearTimingHistory(), formatDuration(), getPerformanceIcon(), getTimingHistory() (+18 more)
...
Cohesion: 0.11
Nodes (23): convertURLSearchParamsToObject(), PushOptions, useSearchParams(), CoreRouteElements, createRouteBuilder(), DeleteRouteBuilder, emptySchema, FetchOptions (+15 more)
...
Cohesion: 0.17
Nodes (21): artifactBundleProviderConfigSchema, bitbucketProviderConfigSchema, containerRegistryProviderConfigSchema, githubProviderConfigSchema, gitlabProviderConfigSchema, manualProviderConfigSchema, providerConfigSchemaById, serviceProviderConfigUnionSchema (+13 more)
...
Cohesion: 0.11
Nodes (29): ExtractMutationContext, CustomInvalidationContext, CustomInvalidationPart, ExtractCustomHookInput, ExtractCustomHookOutput, ExtractCustomHooksKeys, ExtractHookReturnType, ExtractMutationData (+21 more)
...
### Community 234 - "error"
Cohesion: 0.23
Nodes (12): httpStatusToORPCCode(), logOrpcErrors(), transformHttpExceptionToORPCError(), transformNestJSErrorToOrpcError(), DataTableExport(), convertToCSV(), downloadFile(), ExportableData (+4 more)

### Community 235 - "index.ts"
Cohesion: 0.08
Nodes (16): VariableContext, VariableRegistrationError, VariableResolutionError, VariableResolver, NumberVariable, StringVariable, VariableMetadata, ValidationResult (+8 more)
...
Cohesion: 0.11
Nodes (10): CoreDomainModule, Global, Module, OrganizationDomainController, Controller, Implement, DomainModule, Module (+2 more)
...
Cohesion: 0.13
Nodes (10): AppError, BadRequestError, ConflictError, ForbiddenError, NotFoundError, ServiceUnavailableError, TimeoutError, UnauthorizedError (+2 more)
...
Cohesion: 0.05
Nodes (48): cancelEnvelopeSchema, correlationInputSchema, MeshQueueTransitionService, queueTransitionMeshContracts, requestEnvelopeSchema, requestPayloadSchema, responseEnvelopeSchema, Injectable (+40 more)

### Community 257 - "index.ts"
Cohesion: 0.15
Nodes (20): dockerImageSchema, DockerImageLayerEntry, dockerImageLayerEntrySchema, DockerImageRuntimeConfig, dockerImageRuntimeConfigSchema, DockerImageSummary, dockerImageSummarySchema, DockerImageEntity (+12 more)

### Community 258 - "hooks.ts"
Cohesion: 0.13
Nodes (13): AdminOrganizationsPage(), DashboardOverviewClient(), DashboardOverviewClientProps, invitationEndpoints, enhancedInvitation, useAcceptInvitation(), useRejectInvitation(), invitationInvalidations (+5 more)
...
Cohesion: 0.05
Nodes (22): NewNodeMeshConfigRow, nodeMeshConfig, NodeMeshConfigRow, NodeMeshConfigRepository, NodeMeshConfigRow, Injectable, MeshInternalRequestService, Injectable (+14 more)
...
Cohesion: 0.09
Nodes (25): templateApplyVersionMigrationContract, templateListVersionMigrationsContract, templatePreviewVersionMigrationContract, templateVersionMigrationApplyOps, templateVersionMigrationListOps, templateVersionMigrationPreviewOps, TemplateMigrationDirection, TemplateMigrationOperation (+17 more)

### Community 270 - "calendar-date-picker.tsx"
Cohesion: 0.15
Nodes (18): CalendarDatePicker, CalendarDatePickerProps, months, multiSelectVariants, DataTablePagination(), DataTablePaginationProps, getButtonSizeClass(), PopoverContent() (+10 more)
...
Cohesion: 0.16
Nodes (19): DockerVolumeDriver, dockerVolumeDriverSchema, dockerVolumeSchema, DockerVolumeSummary, dockerVolumeSummarySchema, DockerVolumeEntity, DockerVolumeEntityList, dockerVolumeEntityListSchema (+11 more)
...
Cohesion: 0.15
Nodes (7): MeshDuplexStreamInput, MeshDuplexStreamOutput, MeshMembershipSnapshot, MeshPeerConnectInput, MeshPeerConnectResult, MeshPeerDisconnectInput, MeshPeerDisconnectResult
...
Cohesion: 0.10
Nodes (28): DockerContainerDetailModalTrigger(), ContainerProjection, DashboardDockerPage(), DOCKER_LIST_INPUT, fallbackImageRefFromId(), formatDate(), SERVICE_LIST_INPUT, shortId() (+20 more)
...
Cohesion: 0.08
Nodes (17): defineResource(), MeshPartitionPolicy, PartitionPolicyInput, PartitionPolicyResult, NodeDescriptor, OwnershipChange, OwnershipResolverService, Injectable (+9 more)

### Community 293 - "list.ts"
Cohesion: 0.15
Nodes (13): DockerStacksModule, Module, DockerStacksOrchestratorService, Injectable, DockerStacksDomainService, Injectable, dockerStacksContract, dockerListStacksContract (+5 more)
...
Cohesion: 0.14
Nodes (16): cloneValue(), DashboardServiceConfigurationPage(), parseCommaSeparatedValues(), RUNNER_NETWORK_MODES, SERVICE_HEALTH_PROTOCOLS, SERVICE_HEALTH_VALUES, SERVICE_LIFECYCLE_VALUES, SERVICE_RUNNER_STRATEGIES (+8 more)
...
Cohesion: 0.05
Nodes (41): AdminMiddlewareDefinition, MembershipCheck, MiddlewareCheck, PermissionCheck, RoleCheck, SessionCheck, createOrpcMiddlewareProxy(), AppMiddlewares (+33 more)

### Community 312 - "GitHubService"
Cohesion: 0.03
Nodes (19): GitHubModule, Module, GithubDeploymentRulesRepository, Injectable, GithubRepositoryConfigRepository, Injectable, GitHubAppConfig, GitHubCommitAuthor (+11 more)
...
Cohesion: 0.25
Nodes (7): apiUrl, commandLine, getWorkspaceTranspilePackages(), nextConfig, PackageJsonShape, NOTE: do NOT use `import.meta.url` here — Bun 1.3.14 has a transpiler bug, workspaceTranspilePackages
...
Cohesion: 0.17
Nodes (19): DockerRegistry, DockerRegistryAuthMode, dockerRegistryAuthModeSchema, dockerRegistrySchema, DockerRegistryStatus, dockerRegistryStatusSchema, dockerRegistryRepositoryDetailSchema, DockerRegistrySummary (+11 more)
...
Cohesion: 0.10
Nodes (19): OrganizationActionsForResource, PlatformActionsForResource, ProjectActionsForResource, ProjectResource, ORGANIZATION_RESOURCES, ORGANIZATION_ROLES, organizationBuilder, organizationPermissionConfig (+11 more)
...
Cohesion: 0.31
Nodes (3): AbstractDockerContainerService, DockerContainerStartOptions, Injectable

### Community 343 - "catalogs"
Cohesion: 0.05
Nodes (37): better-auth, @thallesp/nestjs-better-auth, auth, doc, linting, react, react-compiler, tanstack (+29 more)
...
Cohesion: 0.12
Nodes (12): templateMigrationDirectionSchema, templateVersionMigrationPreviewInputSchema, templateVersionSchema, builderSchemasCatalog, buildersCatalog, providerSchemasCatalog, providersCatalog, BuilderMetadata (+4 more)

### Community 351 - "DockerImageAutoScanListenerService"
Cohesion: 0.08
Nodes (15): DockerImagesApplicationService, Injectable, AUTO_SCAN_EVENT_ACTIONS, DockerImageAutoScanListenerService, Injectable, ActiveImageScanStream, DockerImageSecurityScanService, EnsureImageSecurityScanOptions (+7 more)

### Community 352 - "mesh-test.module.ts"
Cohesion: 0.16
Nodes (11): bootstrap(), AppModule, ServiceA1, ServiceA1Module, ServiceB1, ServiceB1Module, ServiceB2, ServiceB2Module (+3 more)

### Community 353 - "hooks.ts"
Cohesion: 0.12
Nodes (17): ConnectionState, ConnectionStatus(), Props, LocalDatabaseStep(), Props, AuthOutcome, Props, RemoteAuthStep() (+9 more)
...
Cohesion: 0.14
Nodes (17): HOOKS, AfterHook(), AllowAnonymous(), AuthenticatedUser, AuthHookContext, BeforeHook(), Hook(), Optional (+9 more)

### Community 357 - "MiddlewareCheck"
Cohesion: 0.16
Nodes (7): MiddlewareCheck, OrganizationPermissionCheck, OrganizationRoleCheck, RoleCheck, SessionCheck, AdminChecksBuilder, OrganizationChecksBuilder
...
Cohesion: 0.11
Nodes (14): User, USER_ROLES, USER_STATUS, UserCreate, userCreateSchema, UserInput, UserOutput, UserPublic (+6 more)
...
Cohesion: 0.11
Nodes (19): 10.1 apps/test/ (💀 DEAD), 10.2 apps/observable-poc/ (💀 DEAD), 10.3 reference/ directory (💀 DEAD), 10. 🗺️ Orphaned Apps, 2.1 System Fleet (💀 DEAD — 4 files), 2.2 System Mesh (⚠️ PARTIAL — partially dead), 2.3 System Root Module (💀 DEAD), 2. 💀 Dead System Modules (+11 more)
...
Cohesion: 0.10
Nodes (19): createPathBuilder(), createPathBuilder(), makeRoute(), Home, convertURLSearchParamsToObject(), createPathBuilder(), emptySchema, LinkProps (+11 more)
...
Cohesion: 0.17
Nodes (8): ContainerDockerodeNormalizer, ContainerHashInput, DOCKER_CONTAINER_HEALTH_STATUSES, DOCKER_CONTAINER_STATUSES, Injectable, dockerContainerSchema, DockerPortBinding, DockerodeContainerList
...
Cohesion: 0.16
Nodes (14): coreEventStreamFindByIdContract, coreEventStreamListConfig, coreEventStreamListContract, coreEventStreamOps, coreEventSyncStreamContract, coreEventSyncStreamOps, coreStreamReplayQuerySchema, eventSyncContract (+6 more)
...
Cohesion: 0.11
Nodes (8): RequestedEnvironment, RuntimeConfigurationDispatchConditionInput, RuntimeConfigurationDispatchPatchInput, RuntimeConfigurationDispatchRuleInput, RuntimeConfigurationStateTransitionInput, RuntimeConfigurationStateMachineBuilder, RuntimeRuleDsl, RuntimeTransitionDsl
...
Cohesion: 0.10
Nodes (22): CachedSession, cookieLogger, getRawSessionCookie(), getSessionFromCookie(), hasSessionCookie(), Session, getServerSession(), IMPORTANT: This file has server-side side effects. (+14 more)

### Community 384 - "index.ts"
Cohesion: 0.06
Nodes (19): GET(), deploymentEndpoints, enhancedDeployment, deploymentInvalidations, meshEndpoints, addCacheOperations(), baseOrpc, client (+11 more)
...
Cohesion: 0.15
Nodes (11): LocalAccountStep(), passwordStrength(), Props, strengthLabels, ModeCard(), Props, ButtonGroup(), ButtonGroupSeparator() (+3 more)
...
Cohesion: 0.12
Nodes (16): 2.1 Authentication (✅ WORKING), 2.2 Database (✅ WORKING), 2.3 Mesh (✅ WORKING), 2.4 Events (✅ WORKING), 2.5 Lifecycle (✅ WORKING), 2. API Backend — Core Infrastructure, 3.1 Docker Dashboard (All Docker pages), 3.2 Admin Pages (+8 more)
...
Cohesion: 0.12
Nodes (15): DeploymentTemplateProvenanceEntry, deploymentTemplateProvenanceEntrySchema, DeploymentTemplateProvenanceLayer, deploymentTemplateProvenanceLayerSchema, DeploymentTemplateProvenanceSource, deploymentTemplateProvenanceSourceSchema, builderIds, nonEmptyString (+7 more)

### Community 403 - "utils.ts"
Cohesion: 0.27
Nodes (14): key(), convertToRequiredType(), getAllParamsAsArrays(), getInnerType(), getRequireds(), parseArray(), parseBoolean(), ParsedData (+6 more)

### Community 404 - "QueryBuilder"
Cohesion: 0.14
Nodes (3): createFilteringSchema(), createPaginationSchema(), QueryBuilder
...
Cohesion: 0.25
Nodes (10): autoInvalidate(), createProcedureInvalidator(), commonPatterns, getProcedureQueryKey(), invalidateProcedure(), refetchProcedure(), RouterProcedure, InvalidationStrategy (+2 more)

### Community 411 - "service.service.ts"
Cohesion: 0.18
Nodes (8): ServiceRepository, ServiceRow, toDto(), Injectable, StreamEventWithMeta, ServiceCreateInput, ServiceUpdateInput, ServiceListInput
...
Cohesion: 0.19
Nodes (15): computeServiceDepths(), DependencyRecord, ENV_EDGE_COLORS, EnvironmentGroupNode(), EnvironmentGroupNodeData, getColorForEnvironment(), isDependencyEnabledInEnvironment(), isServiceInEnvironment() (+7 more)
...
Cohesion: 0.24
Nodes (9): Props, createBaseConfig(), defaultConfig, createNextJsConfig(), defaultConfig, createNodeConfig(), defaultConfig, createReactConfig() (+1 more)

### Community 434 - "place-autocomplete.tsx"
Cohesion: 0.17
Nodes (12): CommandItem(), CommandList(), formatAddress(), PlaceAutocomplete(), PlaceAutocompleteProps, PlaceFeature, PlaceFeatureCollection, PlaceFeatureProperties (+4 more)

### Community 435 - "case-utils.ts"
Cohesion: 0.16
Nodes (16): DataTableExportProps, DataTableProps, DataTableToolbarProps, CaseFormat, CaseFormatConfig, convertCase(), ConvertedKeys, convertObjectKeys() (+8 more)
...
Cohesion: 0.15
Nodes (15): RoleGuard, Inject, Injectable, AccessControlInstance, ActionsForResource, AllRoleNames, AuthenticatedUserType, CommonPermissionPattern (+7 more)
...
Cohesion: 0.13
Nodes (11): API (Backend) — 16 Product Modules + 2 System Modules, API Core (Infrastructure) — 23 Core Modules, Dashboard View, Feature Status Assessment, Orphaned Apps, Quick Navigation, Status Legend, Sub-Apps (+3 more)
...
Cohesion: 0.08
Nodes (32): CoreDockerModule, EventsModule, Global, Module, CoreEventLogRepository, Injectable, MeshCoreModule, Module (+24 more)

### Community 445 - "fleet.module.ts"
Cohesion: 0.20
Nodes (9): FLEET_SERVICES, FleetModule, Module, CrossProjectDependency, CrossProjectGateConfig, CrossProjectGateMode, CrossProjectGateService, CrossProjectGateServiceResult (+1 more)

### Community 446 - "DependencyTemplateConfig"
Cohesion: 0.23
Nodes (8): FleetReadinessGateService, GateCheckFn, GateEvaluation, GateStatus, ReadinessGateOptions, ServiceGateResult, Injectable, DependencyTemplateConfig
...
Cohesion: 0.26
Nodes (12): createBooleanFilter(), createBooleanFilterSchema(), createDateFilter(), createDateFilterSchema(), createEnumFilter(), createEnumFilterSchema(), createNumberFilter(), createNumberFilterSchema() (+4 more)
...
Cohesion: 0.18
Nodes (10): exclude, extends, include, ../../apps/web/**, dist, node_modules, ../../packages/**, @repo/config-typescript/nestjs (+2 more)
...
Cohesion: 0.29
Nodes (5): ContainmentInput, ContainmentResult, FailureDomain, FleetFailureContainmentService, Injectable
...
Cohesion: 0.21
Nodes (5): DeploymentLoadBalancerSyncAdapter, LoadBalancerReportedResource, SyncLoadBalancerInput, SyncLoadBalancerResult, Injectable
...
Cohesion: 0.11
Nodes (12): HealthCheckBuilder, LoadBalancerBuilder, ServiceBuilder, HealthCheck, Server, VariableNumber, HttpServiceConfig, LoadBalancerConfig (+4 more)
...
Cohesion: 0.08
Nodes (33): computeDurationLabel(), DashboardDeploymentsPage(), DeploymentSortKey, formatDate(), projectLabel(), severityVariant(), SortDirection, statusBadgeVariant() (+25 more)
...
Cohesion: 0.21
Nodes (11): cloneValue(), CONFIG_TABS, ConfigTabValue, DashboardProjectConfigurationPage(), DEPENDENCY_HEALTH_OPTIONS, DEPENDENCY_REQUIREMENT_OPTIONS, DEPENDENCY_STARTUP_OPTIONS, DependencyHealthGate (+3 more)
...
### Community 502 - "bun"
Cohesion: 0.22
Nodes (9): compilerOptions, outDir, paths, rootDir, types, node, ./src/*, @/* (+1 more)
...
Cohesion: 0.27
Nodes (10): createPaginatedResponseSchema(), createPaginationMetaSchema(), cursorPagination, fullPagination, offsetPagination, pagePagination, PaginationMetaSchemaOutput, PaginationSchemaOutput (+2 more)
...
Cohesion: 0.07
Nodes (31): AfterHook(), AllowAnonymous(), AuthenticatedUser, AuthHookContext, BeforeHook(), Hook(), Optional, OptionalAuth() (+23 more)

### Community 515 - "sorting.ts"
Cohesion: 0.35
Nodes (10): createMultiSortSchema(), createSimpleSortSchema(), createSortingConfigSchema(), createSortingSchema(), extractConfig(), isZodSchemaWithConfig(), nullsHandling, sortDirection (+2 more)
...
Cohesion: 0.25
Nodes (5): TestHookProvider, AfterHook, BeforeHook, decorator, Hook
...
Cohesion: 0.21
Nodes (5): ServiceDagEdge, ServiceDagNode, ServiceDagService, ServiceDependencyInput, Injectable
...
Cohesion: 0.29
Nodes (8): CompositeHooksConfig, CompositeHooksOptions, createCompositeHooks(), getOptionalHook(), MutationResult, QueryResult, defineCustomHooks(), RouterHooks
...
Cohesion: 0.20
Nodes (3): hasProperty(), isObject(), isObjectWithMessage()

### Community 551 - "build.ts"
Cohesion: 0.38
Nodes (6): args, buildContracts(), ChokidarModule, rootDir, setupWatcher(), watch

### Community 552 - ".testMethod"
Cohesion: 0.43
Nodes (5): TestController, AllowAnonymous, AuthenticatedUser, OptionalAuth, UserRoles
...
Cohesion: 0.11
Nodes (14): DEPLOYER_VERSION, __dirname, __filename, NodeStartupCheckCommand, PKG_PATH, StartupCheckOutput, Command, Injectable (+6 more)
...
Cohesion: 0.33
Nodes (8): createFilteringConfigSchema(), createPaginationConfigSchema(), createAdvancedQuery(), createListQuery(), createQueryBuilder(), createSearchQuery(), InputType, OutputType
...
Cohesion: 0.60
Nodes (4): BaseEndpointConfig, CustomEndpoint, EndpointConfig, ORPCEndpoint
...
Cohesion: 0.50
Nodes (7): baseSearchSchema, createFullTextSearchSchema(), createSearchConfigSchema(), createSearchSchema(), createSimpleSearchSchema(), SearchConfigOptions, searchWithHighlightSchema
...
Cohesion: 0.14
Nodes (10): nextjs-toploader, geist, metadata, HintDef, HintResult, HINTS, PostSetupHints(), nextjs-toploader (+2 more)
...
### Community 691 - "1. 💀 Dead Core Modules (Superseded)"
Cohesion: 0.33
Nodes (6): 1.1 State Machine (💀 DEAD — 4 files), 1.2 Sub-App Orchestrator (💀 DEAD — 2 files), 1.3 Sub-App Runner (💀 DEAD — 3 files), 1.4 Loader (💀 DEAD — 3 files), 1.5 Gateway (💀 DEAD — 3 files), 1. 💀 Dead Core Modules (Superseded)
...
## Knowledge Gaps
- **6895 isolated node(s):** `Table of Contents`, `When to Read Documentation`, `Documentation Discovery Pattern`, `Scoped AGENTS.md Files (Read Before Touching Code)`, `❌ Banned Patterns` (+6890 more)
...
- **Why does `vitest` connect `vitest` to `pagination.ts`, `test.controller.ts`, `sorting.ts`, `HTTP/Traefik Router Builder`, `Permission & Role Checks`, `Docker Container Inspection`, `Docker Runtime Activity Projection`, `cn`, `SystemMeshTopologyService`, `index.ts`, `AuthCoreService`, `platform-domain.builder.ts`, `mesh-connection-registry.ts`, `service-dag.service.ts`, `DockerRuntimeRunnerService`, `DeploymentTriggerInput`, `DeploymentService`, `stream.ts`, `docker-entity-domain.service.ts`, `ProjectService`, `middlewares.ts`, `index.ts`, `build-tools.ts`, `permission-engine.ts`, `deployment-queue-lifecycle.service.ts`, `mesh-query-builder-types.ts`, `query-builder.test.ts`, `core-event-sync.service.ts`, `index.ts`, `DockerRepository`, `ServiceDomainMappingRepository`, `InitializationService`, `index.ts`, `resource-graph.ts`, `common.ts`, `search.ts`, `GlobalDatabaseService`, `auth-core.service.ts`, `github.module.ts`, `DeploymentMeshService`, `deployment.service.spec.ts`, `index.ts`, `standard-schema-helpers.ts`, `route-builder.ts`, `AnalyticsService`, `standard-operations.ts`, `index.ts`, `AppLifecycleService`, `user.repository.ts`, `PushRepository`, `deployment-provider-builder-runner-state-machine.service.ts`, `ServiceService`, `index.ts`, `InternalErrorInsightService`, `docker-runtime-stream-orchestrator.service.ts`, `auth-module-definition.ts`, `generate-hooks.ts`, `shared-api-runtime.ts`, `organization.repository.ts`, `traefik-config-builder.ts`, `index.ts`, `index.ts`, `configuration-core.module.ts`, `utils.ts`, `DeploymentRepository`, `package.json`, `route-method-meta.ts`, `index.ts`, `TraefikConfigBuilder`, `index.ts`, `ApiKeyRepository`, `project.module.ts`, `ProjectDomainRepository`, `types.ts`, `index.ts`, `DeploymentQueueProcessor`, `index.ts`, `mesh-filter.ts`, `index.ts`, `ProviderSchemaService`, `domain.module.ts`, `utils.test.ts`, `SystemMeshConfigService`, `mesh-subscription-manager.ts`, `mesh-doc-compliance-matrix.e2e-spec.ts`, `load-balancer.service.ts`, `configuration-resolver.service.ts`, `rule-validator.ts`, `template.schema.exhaustive.test.ts`, `decorators.ts`, `devDependencies`, `development-session.ts`, `LocalEventOutboxDispatcherService`, `service.service.ts`, `fleet-rollout-planner.service.ts`, `load-balancer.controller.ts`, `mesh-observable-types.ts`, `fleet-rollback.service.ts`, `package.json`, `filtering.ts`, `drift-reconciliation.service.ts`, `fleet-failure-containment.service.ts`, `DockerRuntimeActivityProjectorService`, `VariableNumber`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `isRecord()` connect `isRecord` to `TraefikSyncService`, `Permission & Role Checks`, `Docker Container Inspection`, `Mesh Core & Orchestration`, `SystemMeshConfigService`, `DockerRuntimeEvent`, `generate-hooks.ts`, `Docker Runtime Activity Projection`, `Mesh Cluster Repository`, `Deployment Pipeline Service`, `page.tsx`, `toolbar.tsx`, `DockerContainerRuntimeService`, `mesh-connection-registry.ts`, `service.service.ts`, `page.tsx`, `DeploymentTriggerInput`, `DeploymentService`, `page.tsx`, `docker.repository.ts`, `docker-entity-domain.service.ts`, `index.ts`, `docker-container-runtime.service.ts`, `ProjectService`, `DeploymentRepository`, `index.ts`, `node-startup-check.command.ts`, `page.tsx`, `core-event-sync.service.ts`, `route-method-meta.ts`, `index.ts`, `index.ts`, `DockerRepository`, `InitializationService`, `isObjectLike`, `index.ts`, `GlobalDatabaseService`, `hooks.ts`, `github.module.ts`, `rule-validator.ts`, `server.tsx`, `types.ts`, `MeshResourceSubQueryBuilder`, `MeshControlEnvelope`, `index.ts`, `standard-schema-helpers.ts`, `index.ts`, `deployment.ts`, `standard-operations.ts`, `MeshTrustStrictModeService`, `index.ts`, `data-table.tsx`, `index.ts`, `index.ts`, `.error`, `DockerRuntimeActivityProjectorService`, `.params`, `ContainerDockerodeNormalizer`, `drizzle-filter.utils.ts`, `InternalErrorInsightService`, `runtime-configuration-accessor.ts`, `app-error.ts`, `docker-runtime-stream-orchestrator.service.ts`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `requireAuth()` connect `requireAuth` to `AnalyticsService`, `ServiceDomainMappingRepository`, `test.controller.ts`, `docker-entity-domain.service.ts`, `TestController`, `ProjectService`, `middlewares.ts`, `AppLifecycleService`, `Docker Module Wiring`, `ProviderSchemaService`, `domain.module.ts`, `user.repository.ts`, `ProjectDomainRepository`, `PushRepository`, `organization.repository.ts`, `ServiceService`, `index.ts`, `AbstractDomainEventStreamService`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **What connects `Table of Contents`, `When to Read Documentation`, `Documentation Discovery Pattern` to the rest of the system?**
...
- **Should `TypeScript Type Utilities` be split into smaller, more focused modules?**
  _Cohesion score 0.005115089514066497 - nodes in this community are weakly interconnected._
- **Should `Mesh Networking Contracts` be split into smaller, more focused modules?**
  _Cohesion score 0.011626432165053059 - nodes in this community are weakly interconnected._
