...
## Corpus Check
- 2365 files · ~2,104,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19983 nodes · 38708 edges · 999 communities (691 shown, 308 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 587 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `655389d0`
...
- [[_COMMUNITY_@octokitapp|@octokit/app]]
- [[_COMMUNITY_@octokitwebhooks|@octokit/webhooks]]
- [[_COMMUNITY_openapi-merge|openapi-merge]]
...
- [[_COMMUNITY_@repoapi-contracts|@repo/api-contracts]]
- [[_COMMUNITY_@repoenv|@repo/env]]
- [[_COMMUNITY_@repoprovider-schema|@repo/provider-schema]]
- [[_COMMUNITY_rxjs|rxjs]]
- [[_COMMUNITY_simple-git|simple-git]]
- [[_COMMUNITY_TraefikCoreModule|TraefikCoreModule]]
- [[_COMMUNITY_Module|Module]]
...
## Communities (999 total, 308 thin omitted)
...
Cohesion: 0.01
Nodes (217): systemMeshEventContracts, meshConnectPeerContract, meshConsumeJoinGrantContract, meshContract, meshControlEnvelopePublishContract, meshControlEnvelopePublishOps, meshDisconnectPeerContract, meshEventStreamByIdOps (+209 more)
...
Cohesion: 0.04
Nodes (34): AdminAuthConstraint, AdminPluginFactory, HasPermissionByRoleCheck, HasPermissionCheck, HasRoleCheck, RequireAdminRoleCheck, AnyMiddlewareDefinition, AuthWithSessionAPI (+26 more)
...
Cohesion: 0.05
Nodes (60): SystemMeshEventService, Injectable, MESH_TOPIC_SERVICES, MESH_TOPOLOGY_SERVICES, StubMeshNodeCaller, MeshRuntimeModule, Module, MeshConfigTrustKeys (+52 more)

### Community 10 - "Docker Container Actions"
Cohesion: 0.04
Nodes (93): dockerContainerActionsContract, dockerContainerCreateDirectoryContract, dockerContainerCreateDirectoryOps, dockerContainerDeletePathContract, dockerContainerDeletePathOps, dockerContainerFilesystemContract, dockerContainerFilesContract, dockerContainerFilesOps (+85 more)
...
Cohesion: 0.05
Nodes (13): MeshClusterSyncService, Injectable, MeshMembershipService, Injectable, MeshMembershipReconcileInput, MeshMembershipReconcileResult, MeshMembershipSnapshot, MeshNodeState (+5 more)

### Community 13 - "Docker Runtime Activity Projection"
Cohesion: 0.04
Nodes (91): DockerKnownSource, DockerRawEvent, RuntimeEventFieldFilter, RuntimeEventFilterNode, StreamQuery, DockerRuntimeSystemEvent, dockerContainerEntitySchema, buildDockerEntityEventChunk() (+83 more)
...
Cohesion: 0.02
Nodes (95): BASE_PHASE_TRANSITIONS, BASE_RETRY_POLICIES, CANCELLABLE_STATUSES, TODO: Queue retry job via orchestration module (not yet migrated), StreamEventWithMeta, StreamReplayInput, deploymentCompilePlanContract, deploymentCompilePlanPreviewContract (+87 more)

### Community 16 - "hooks.ts"
Cohesion: 0.03
Nodes (99): coerceContainerLogEntry(), CONTAINER_METRICS_STREAM_ACTIONS, debugDockerModalLogs, DockerContainerDetailModalContent(), DockerContainerDetailModalContentProps, DockerContainerDetailModalTriggerProps, DockerTerminalSessionState, extractContainerLogEntries() (+91 more)

### Community 17 - "cn"
Cohesion: 0.03
Nodes (89): DataTableResizer(), ExpandIcon(), ExpandIconProps, Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount() (+81 more)

### Community 18 - "SystemMeshTopologyService"
Cohesion: 0.05
Nodes (29): MeshEntity, MeshOperation, SystemMeshTopicService, Injectable, SystemMeshTopologyService, Injectable, deploymentsEntity, deploymentSummarySchema (+21 more)

### Community 19 - "types.ts"
Cohesion: 0.06
Nodes (57): BASE_CONFIGURATION, MOCK_PROJECT_CONFIGURATIONS, getDependencyPolicyKey(), MOCK_POLICY_OVERRIDES_BY_PROJECT, MOCK_ORGANIZATIONS, BASE_STATUS, createDefaultServiceConfig(), createExecutionOverrides() (+49 more)

### Community 20 - "index.ts"
Cohesion: 0.04
Nodes (38): verificationMethodEnum, verificationStatusEnum, BasePathValidationResult, SubdomainAvailabilityResult, SubdomainConflict, SubdomainValidationResult, InsertOrganizationDomain, ListDomainsOptions (+30 more)
...
Cohesion: 0.13
Nodes (9): MODULE_OPTIONS_TOKEN, AuthContextErrorMap, AuthErrorType, AuthGuard, Inject, Injectable, RoleGuard, SessionUserWithRole (+1 more)
...
Cohesion: 0.06
Nodes (74): DockerStackDetailModalTrigger(), DockerStackDetailModalTriggerProps, aggregateDeploymentMetrics(), buildBuilderLogs(), BuilderLogProjection, buildReplicaMetrics(), createDeploymentLogsSearch(), createReplicaLogsSearch() (+66 more)
...
Cohesion: 0.07
Nodes (57): DeploymentCreateInput, QueueJobLike, DeploymentStoragePolicyResolver, ResolveDeploymentStoragePolicyInput, DeploymentStoragePolicy, deploymentStoragePolicyBaseSchema, deploymentStoragePolicyLooseSchema, deploymentStoragePolicySchema (+49 more)

### Community 32 - "DeploymentService"
Cohesion: 0.08
Nodes (16): MeshStreamRuntimeService, Injectable, DeploymentStreamBridgeService, Injectable, DeploymentStreamOrchestratorService, OpenDeploymentStreamInput, Injectable, toStreamDto() (+8 more)

### Community 33 - "stream.ts"
Cohesion: 0.03
Nodes (80): deploymentEventContracts, deploymentCancelExecutionContract, deploymentExecutionCancelOps, deploymentExecutionCheckpointByRunOps, deploymentExecutionCheckpointOps, deploymentExecutionResumeOps, deploymentGetExecutionCheckpointByRunContract, deploymentGetExecutionCheckpointContract (+72 more)
...
Cohesion: 0.06
Nodes (30): dockerRuntimeActivities, dockerRuntimeActivityCategoryEnum, dockerRuntimeActivitySeverityEnum, dockerRuntimeActivityStatusEnum, dockerImageLifecycleStateEnum, dockerImageSecurityLifecycle, dockerImageSecurityScanHistory, dockerImageSecurityScans (+22 more)
...
Cohesion: 0.05
Nodes (48): CreateAdminMiddlewareOptions, AdminPlugin, AdminPluginInstance, AdminPluginWrapperOptions, ApiMethodsWithAdminPlugin, AuthWithAdminPlugin, NOTE: Uses only TPermissionBuilder as generic parameter - TStatement and TRoles, NOTE: Uses only TPermissionBuilder and TAuth as generic parameters. (+40 more)

### Community 39 - "BaseEventService"
Cohesion: 0.06
Nodes (3): BaseEventMergeBuilder, BaseEventService, TestEventService

### Community 40 - "ProjectService"
Cohesion: 0.04
Nodes (28): ProjectController, TODO: trigger actual health check, Controller, Implement, ProjectModule, Module, ProjectRepository, transformCollaborator() (+20 more)

### Community 41 - "middlewares.ts"
Cohesion: 0.09
Nodes (22): AuthUtils, AuthUtilsEmpty, buildMeshContext(), parseParcour(), readEnv(), resolveSharedSecret(), NOTE: accessControl has been removed in favor of plugin-based middlewares, AuthPlugin (+14 more)

### Community 42 - "index.ts"
Cohesion: 0.05
Nodes (76): ContainerHashInput, deploymentEnvironmentSchema, DockerContainerHealth, dockerContainerHealthSchema, DockerContainerStatus, dockerContainerStatusSchema, DockerListMeta, dockerListMetaSchema (+68 more)
...
Cohesion: 0.05
Nodes (34): CoreEventStreamRepository, toDto(), Injectable, AliasForService, AnyServiceSelection, ContractsOf, CoreEventAdapterEvent, CoreEventAdapterInput (+26 more)

### Community 47 - "LocalDatabaseService"
Cohesion: 0.07
Nodes (20): test(), nest-commander, bootstrap(), CLIModule, logger, SeedCommand, Command, Injectable (+12 more)

### Community 48 - "permission-engine.ts"
Cohesion: 0.15
Nodes (15): ColumnResolver, buildDynamicVars(), ForbiddenError, MemberRoleLoader, OrgRoleLoader, PermissionEngine, PermissionEngineOptions, ResourceRecordLoader (+7 more)
...
Cohesion: 0.04
Nodes (60): AnyRecord, MeshChangeEvent, MeshChangeType, MeshListenResult, MeshOperation, MeshRequestResult, MeshStreamEvent, MeshStreamEventType (+52 more)

### Community 53 - "docker-runtime-activity-domain.service.ts"
Cohesion: 0.07
Nodes (30): DockerRuntimeActivityDomainService, Injectable, DockerRuntimeOrchestratorService, Injectable, dockerRuntimeActivityDetailContract, dockerRuntimeActivityDetailOps, DockerRuntimeActivityDetailQueryInput, dockerRuntimeActivityDetailQuerySchema (+22 more)
...
Cohesion: 0.05
Nodes (76): InferBuilderFieldOperators, InferBuilderFieldValue, isExistingFieldFilterConfig(), isSchemaWithOperators(), ListOperationBuilder, normalizeFilterField(), NormalizeFilterFields, createZodListOptions() (+68 more)

### Community 56 - "core-event-sync.service.ts"
Cohesion: 0.04
Nodes (61): createOutputFn(), AnyEventEmission, EventSubscription, EventContract, EventContractBuilder, EventContracts, EventInput, EventOutput (+53 more)
...
Cohesion: 0.07
Nodes (21): testContracts, contractBuilder(), BASE_DOMAIN_STREAM_SERVICE_SYMBOL, BaseDomainStreamServiceSymbolized, DomainStreamMergeRegisteredOptions, DomainStreamSelection, DomainStreamServiceRegistryEntry, BasePooledEventService (+13 more)
...
Cohesion: 0.05
Nodes (69): DockerDetailLoadingStateProps, DockerInlineLoadingState(), DockerInlineLoadingStateProps, DockerTableLoadingRows(), DockerTableLoadingRowsProps, DockerBatchOperationsBar(), DockerBatchOperationsBarProps, DockerOperationProgressPanel() (+61 more)

### Community 64 - "DockerRepository"
Cohesion: 0.05
Nodes (9): DockerRepository, ScannerRunProgressOptions, Injectable, DockerImageSecurityRepository, Injectable, DockerRuntimeActivityRepository, Injectable, DockerContainerLinkPath (+1 more)

### Community 65 - "ServiceDomainMappingRepository"
Cohesion: 0.04
Nodes (22): DomainAdapter, InsertServiceDomainMapping, ServiceDomainMapping, ServiceDomainMappingWithUrls, ProjectDomainRepository, Injectable, ServiceDomainMappingRepository, Injectable (+14 more)
...
Cohesion: 0.06
Nodes (17): MeshContract, MeshInitializationModule, Module, MeshBootstrapConfig, MeshInitializationService, MeshSetupSession, MeshVersionService, MeshVersionSummary (+9 more)

### Community 69 - "BaseTriggerService"
Cohesion: 0.07
Nodes (24): createResultBridge(), BridgeResult, SUB_APP_RESULT(), store, SubAppResultStore, logger, SubAppRunner, BaseTriggerService (+16 more)

### Community 70 - "isObjectLike"
Cohesion: 0.08
Nodes (57): s, CONFIG_SYMBOL, SchemaWithConfig, withConfig(), comparisonField(), createFieldFilterSchema(), createFilteringConfigSchema(), createFilteringSchema() (+49 more)

### Community 71 - "index.ts"
Cohesion: 0.10
Nodes (18): redirect(), mocks, SignInPageLoose, loginSchema, signupSchema, formatDate(), getInitials(), ProfileForm() (+10 more)

### Community 72 - "index.ts"
Cohesion: 0.03
Nodes (92): addCacheOperations(), baseOrpc, client, Context, createORPCClientWithCookies(), createOrpcInternal(), EnhancedOrpc, Plugins (+84 more)

### Community 73 - "common.ts"
Cohesion: 0.06
Nodes (37): ORPCGlobalContext, HOOKS, BootstrapModule, DatabaseModule, GlobalDatabaseModule, logger, requireDatabaseUrl(), useFactoryDrizzle() (+29 more)

### Community 75 - "dependencies"
Cohesion: 0.05
Nodes (38): dependencies, drizzle-zod, eslint, nanoid, @nestjs/common, @nestjs/websockets, @octokit/rest, @octokit/webhooks-types (+30 more)
...
Cohesion: 0.06
Nodes (23): CliAuthContext, CliAuthMethod, IMPORTANT: This method creates the user directly in the database (not via admin, serviceDependencies, deploymentCache, imageProjectMembership, projectScanConfig, localBuildCache (+15 more)
...
Cohesion: 0.06
Nodes (29): DeploymentCoreModule, Module, PreviewCleanupDecision, PreviewCleanupPolicyService, PreviewCleanupTrigger, Injectable, PreviewNamingInput, PreviewNamingResult (+21 more)
...
Cohesion: 0.04
Nodes (44): GitModule, Module, GitService, Injectable, BuildArtifactInput, CliEnablement, CustomCommandsConfig, DeploymentArtifactBuilderService (+36 more)
...
Cohesion: 0.05
Nodes (32): ErrorDefinitionBuilder, ExtractErrorFromBuilder, createPathParamBuilder(), ExtractPathParams, ParamsToSchemaShape, PathParam, PathParamBuilder, PathParamBuilderWithExisting (+24 more)
...
Cohesion: 0.05
Nodes (30): ExtractErrorsFromBuilders, CompactDetailedInputShape, CurrentDetailedInputParts, CurrentInputBody, CurrentInputHeaders, CurrentInputParams, CurrentInputQuery, Detailed (+22 more)

### Community 93 - "index.ts"
Cohesion: 0.08
Nodes (45): ClientSessionInjectedProps, ComponentWithDisplayName, CoreRouteElements, DeleteRouteBuilder, emptySchema, FetchOptions, GetRouteBuilder, LinkProps (+37 more)
...
Cohesion: 0.03
Nodes (85): apiKeysRelations, deploymentEnvironmentEnum, deploymentLogs, deploymentLogsRelations, deploymentPhaseEnum, deploymentRollbacks, deploymentRollbacksRelations, deploymentRules (+77 more)
...
Cohesion: 0.08
Nodes (39): ServiceConfigSubNav(), Density, LIST_INPUT, ServiceOpsOverviewCards(), ServiceOpsOverviewCardsProps, toBadgeVariant(), sectionLabel, sectionRoute (+31 more)
...
Cohesion: 0.10
Nodes (11): MeshTrustStrictModeService, Inject, Injectable, MeshTrustKeyringConvergenceStatusResult, MeshTrustStrictModeSetCommandInput, MeshTrustStrictModeSetResult, MeshTrustStrictReadinessResult, MeshTrustStrictRollbackCommandInput (+3 more)
...
Cohesion: 0.07
Nodes (65): any(), array(), boolean(), coerceBoolean(), coerceNumber(), date(), enumeration(), extend() (+57 more)

### Community 107 - ".error"
Cohesion: 0.05
Nodes (13): deserializeTraefikConfigBuilder(), logger, serializeTraefikConfigBuilder(), traefikConfigBuilder, AbstractDockerContainerService, DockerContainerStartOptions, Injectable, DockerService (+5 more)
...
Cohesion: 0.06
Nodes (39): Route, BasePageProps, CoreRouteElements, createPathBuilder(), createRouteBuilder(), createRouteInfo(), DeleteRouteBuilder, FetchOptions (+31 more)

### Community 111 - "index.ts"
Cohesion: 0.08
Nodes (24): ComposeConfig, DockerContainerComposeTab(), DockerContainerComposeTabProps, DockerContainerConfigTab(), DockerContainerConfigTabProps, RuntimeConfig, DockerContainerEnvTab(), DockerContainerEnvTabProps (+16 more)

### Community 112 - "user.repository.ts"
Cohesion: 0.08
Nodes (15): createImplementMock(), mockAuthUser, Controller, Implement, UserController, CreateUserInput, GetUserOutput, GetUsersInput (+7 more)
...
Cohesion: 0.07
Nodes (26): CONTAINER_LINK_RESOLVER, ContainerEnrichment, IContainerLinkResolver, DeploymentModule, Module, PreviewEnvOverlayService, Injectable, DeploymentProvidersModule (+18 more)
...
Cohesion: 0.06
Nodes (31): DeploymentBuilderKind, deploymentBuilderKindSchema, DeploymentEnvironment, deploymentEnvironmentSchema, DeploymentExecutionStateMachineInput, deploymentExecutionStateMachineInputSchema, DeploymentExecutionStateMachineResolution, DeploymentExecutionStateMachineViolation (+23 more)

### Community 117 - "ServiceService"
Cohesion: 0.05
Nodes (26): CoreDomainModule, Global, Module, ProjectCoreModule, Module, ProjectAccessService, Injectable, createDeploymentCompleteStrategyContext() (+18 more)
...
Cohesion: 0.11
Nodes (12): CreateContainerOptions, SCANNER_META, SCANNER_TYPES, ScannerContainerState, ScannerExecResult, ScannerType, ContainerMetricsSelector, DockerContainerMetricsStreamService (+4 more)
...
Cohesion: 0.05
Nodes (42): templateCompatibilityMatrixOps, templateCompatibilityValidationOps, templateGetCompatibilityMatrixContract, templateValidateCompatibilityContract, templateCreateContract, templateOps, templateDeleteContract, templateOps (+34 more)
...
Cohesion: 0.06
Nodes (19): createGatewayCatchAll(), handleProxy(), GatewayService, proxyRequest(), RouteRegistryService, HttpMethod, RouteEntry, RoutePattern (+11 more)

### Community 127 - "docker-runtime-stream-orchestrator.service.ts"
Cohesion: 0.08
Nodes (10): InternalBaseMeshService, DockerRuntimeActivityPersistenceService, Injectable, DockerRuntimeEventsStreamService, Injectable, dockerRuntimeMeshContracts, DockerRuntimeMeshRelayService, runtimeTopicInputSchema (+2 more)
...
Cohesion: 0.09
Nodes (16): DockerContainerLogsSnapshot, DockerContainerLogsSnapshotRequestPayload, DockerContainerProcessesSnapshot, DockerContainerProcessesSnapshotRequestPayload, DockerContainerProcessLogsSnapshotRequestPayload, DockerContainerLogsDomainService, Injectable, DockerContainerProcessesTabProps (+8 more)
...
Cohesion: 0.03
Nodes (46): GET(), deploymentEndpoints, enhancedDeployment, deploymentInvalidations, meshInvalidations, serviceEndpointOperations, serviceEndpoints, enhancedService (+38 more)
...
Cohesion: 0.06
Nodes (39): ScannerRunResult, DockerContainerSecurityTabProps, DockerImageScanFindingEntry, DockerImageLayerEfficiency, dockerImageLayerEfficiencySchema, DockerImageScannerResult, dockerImageScannerResultSchema, DockerImageScannerStatus (+31 more)
...
Cohesion: 0.11
Nodes (20): DetailedInputBuilderSchema, createLiveQueryHook(), createMutationHook(), createQueryHook(), createStreamedQueryHook(), ExtractInput, ExtractMutationInput, ExtractMutationOutput (+12 more)

### Community 142 - "platform-domain.schema.ts"
Cohesion: 0.04
Nodes (54): organizationDomains, organizationDomainsRelations, projectDomains, projectDomainsRelations, serviceDomainMappings, serviceDomainMappingsRelations, sslProviderEnum, cacheStrategyEnum (+46 more)
...
Cohesion: 0.03
Nodes (54): account, accountRelations, invitation, invitationRelations, memberRelations, organization, organizationRelations, organizationRole (+46 more)
...
Cohesion: 0.06
Nodes (46): StreamEventWithMeta, serviceCreateContract, ServiceCreateInput, serviceCreateInputSchema, serviceDeleteContract, serviceFindByIdContract, serviceCrudContract, serviceObjectSchema (+38 more)
...
Cohesion: 0.08
Nodes (39): AdminInvitesPage(), AdminMembersPage(), AdminOrganizationDetailPage(), AdminSettingsPage(), AdminOrganizationsPage(), getMembersArray(), isOrganizationRoleAtLeast(), RequireOrganizationRole() (+31 more)

### Community 170 - ".key"
Cohesion: 0.11
Nodes (3): MeshResourceBuilder, compareHlc(), LwwMap

### Community 171 - "DeploymentRepository"
Cohesion: 0.06
Nodes (20): DeploymentStateMachineScopeConfigInput, DeploymentEventService, Injectable, DeploymentRepository, getMetaString(), toDto(), toLogDto(), toRollbackDto() (+12 more)
...
Cohesion: 0.08
Nodes (21): isFieldOptional(), shouldBeOptional(), AllKeysOptional, AnyObjectSchema, AnyObjectSchemaWithShape, ExtendSchemaType, ExtractShape, getSchemaOperations() (+13 more)

### Community 177 - "DetailedOutputBuilder"
Cohesion: 0.18
Nodes (13): ProxyBuilderBase, DetailedOutput, DetailedOutputBrand, DetailedOutputBuilder, ExtractOutputBody, ExtractOutputHeaders, ExtractOutputStatus, isDetailedMode() (+5 more)
...
Cohesion: 0.08
Nodes (32): testAuthenticatedContract, TestAuthenticatedInput, testAuthenticatedOps, TestAuthenticatedOutput, testFileDownloadContract, TestFileDownloadInput, testFileDownloadOps, TestFileDownloadOutput (+24 more)
...
Cohesion: 0.10
Nodes (30): ContractProcedureMetadata, detectOperationType(), isEventIteratorOutput(), OperationType, getObservableSchemaDetails(), createRouteMethodMeta(), getRouteMethod(), HasRouteMethodMeta (+22 more)
...
Cohesion: 0.09
Nodes (17): CompiledContextFilterPattern, ContextFilterLoggerOptions, ContextFilterLoggerSource, ContextFilterPatternKind, ExtractedSourceIdentity, AppLoggerContextFilterOptions, createConsoleBackend(), createLogger() (+9 more)
...
Cohesion: 0.08
Nodes (16): ProviderTraefikTemplate, providerTraefikTemplates, ServiceTraefikTemplate, serviceTraefikTemplates, TemplateVariables, ValidationResult, ValidationWarning, VariableInfo (+8 more)
...
Cohesion: 0.07
Nodes (35): projectGeneralConfigOps, projectGetGeneralConfigContract, projectGeneralConfigOps, projectGeneralConfigUpdateInputSchema, projectUpdateGeneralConfigContract, projectCreateVariableTemplateContract, projectDeleteVariableTemplateContract, projectGetVariableTemplateContract (+27 more)

### Community 203 - "docker.mock.ts"
Cohesion: 0.07
Nodes (25): MOCK_DOCKER_CONTAINERS, MOCK_DOCKER_DEPLOYMENTS, MOCK_DOCKER_FLEET_SERVERS, MOCK_DOCKER_IMAGES, MOCK_DOCKER_IMAGES_ENTITIES, MOCK_DOCKER_LOG_LINES, MOCK_DOCKER_MESH_EVENT_STREAMS, MOCK_DOCKER_MESH_STATE (+17 more)
...
Cohesion: 0.11
Nodes (9): ApiKeyRepository, Injectable, ApiKeyService, CreateApiKeyInput, IssueApiKeyResult, RotateApiKeyResult, mockKeyRecord, mockProject (+1 more)
...
Cohesion: 0.08
Nodes (18): publicAccess(), collectStreamEvents(), runLocalSetup(), SetupResult, SetupStreamEvent, collectStreamEvents(), runLocalSetup(), SetupStreamEvent (+10 more)
...
Cohesion: 0.09
Nodes (27): CapabilityStatus, platformCapabilities, PlatformCapability, addTimingEntry(), clearTimingHistory(), formatDuration(), getPerformanceIcon(), getTimingHistory() (+19 more)
...
Cohesion: 0.12
Nodes (15): sonner, peerDependencies, class-variance-authority, clsx, cmdk, framer-motion, @hookform/resolvers, lucide-react (+7 more)
...
Cohesion: 0.04
Nodes (53): getPublicKeyContract, getPublicKeyOutputSchema, pushPublicKeyOps, deviceSchema, getStatsContract, getStatsOutputSchema, pushStatsOps, getSubscriptionsContract (+45 more)

### Community 224 - "service.schema.ts"
Cohesion: 0.16
Nodes (22): artifactBundleProviderConfigSchema, bitbucketProviderConfigSchema, containerRegistryProviderConfigSchema, githubProviderConfigSchema, gitlabProviderConfigSchema, manualProviderConfigSchema, providerConfigSchemaById, serviceProviderConfigUnionSchema (+14 more)
...
Cohesion: 0.08
Nodes (33): CachedSession, cookieLogger, getRawSessionCookie(), getSessionFromCookie(), hasSessionCookie(), Session, getServerSession(), IMPORTANT: This file has server-side side effects. (+25 more)
...
Cohesion: 0.09
Nodes (16): BASE_EVENT_SERVICE_SYMBOL, BaseEventServiceRegistryEntry, BaseEventServiceSymbolized, BufferedEventRecord, EventLogPersistenceAdapter, EventSubscriptionData, MergedDomainEventEnvelope, MergeRegisteredOptions (+8 more)
...
Cohesion: 0.09
Nodes (12): CoreEventStreamRow, CommonOperators, createCommonOperators(), DynamicCapableQuery, FilterResolvers, FilterWithLogical, FromParam, listBuilder() (+4 more)
...
Cohesion: 0.12
Nodes (12): apiKeys, AppError, BadRequestError, ConflictError, ForbiddenError, NotFoundError, ServiceUnavailableError, TimeoutError (+4 more)
...
Cohesion: 0.04
Nodes (58): cancelEnvelopeSchema, correlationInputSchema, MeshQueueTransitionService, queueTransitionMeshContracts, requestEnvelopeSchema, requestPayloadSchema, responseEnvelopeSchema, Injectable (+50 more)

### Community 257 - "index.ts"
Cohesion: 0.11
Nodes (23): dockerContainerRuntimeEventSchema, dockerImageSchema, dockerImageInspectDetailSchema, DockerImageLayerEntry, dockerImageLayerEntrySchema, DockerImageRuntimeConfig, dockerImageRuntimeConfigSchema, DockerImageSummary (+15 more)

### Community 258 - "hooks.ts"
Cohesion: 0.08
Nodes (26): DashboardOverviewClient(), DashboardOverviewClientProps, invitationEndpoints, STALE_TIME, enhancedInvitation, useAcceptInvitation(), useRejectInvitation(), invitationInvalidations (+18 more)
...
Cohesion: 0.05
Nodes (9): ContextUtils, ProjectContext, ProjectContextBuilder, ServiceContext, ServiceContextBuilder, ServiceDomainMapping, TraefikVariableResolverService, Injectable (+1 more)

### Community 266 - "SystemMeshConfigService"
Cohesion: 0.05
Nodes (25): NewNodeMeshConfigRow, nodeMeshConfig, NodeMeshConfigRow, NodeMeshConfigRepository, NodeMeshConfigRow, Injectable, MeshInternalRequestService, Injectable (+17 more)
...
Cohesion: 0.13
Nodes (22): CalendarDatePicker, CalendarDatePickerProps, months, multiSelectVariants, DataTablePagination(), DataTablePaginationProps, getButtonSizeClass(), Button() (+14 more)
...
Cohesion: 0.15
Nodes (22): dockerode, stopAllSharedApiRuntimes(), globalSetup(), deleteSharedPostgresUriFile(), describeActiveHandles(), describeActiveRequests(), isTruthyEnv(), logSharedPostgres() (+14 more)
...
Cohesion: 0.21
Nodes (8): MeshStreamSessionService, Injectable, MeshDuplexStreamInput, MeshDuplexStreamOutput, MeshPeerConnectInput, MeshPeerConnectResult, MeshPeerDisconnectInput, MeshPeerDisconnectResult
...
Cohesion: 0.05
Nodes (46): projectGetCollaboratorsContract, projectInviteCollaboratorContract, projectRemoveCollaboratorContract, projectCollaboratorInviteOps, projectCollaboratorOps, projectCollaboratorParamsSchema, projectIdParamSchema, projectUpdateCollaboratorContract (+38 more)
...
Cohesion: 0.04
Nodes (52): Auth, AuthModuleOptions, AuthWithPlugins, { ConfigurableModuleClass, OPTIONS_TYPE, ASYNC_OPTIONS_TYPE }, PermissionApiExtras, WithPermissionApis, createOrpcMiddlewareProxy(), AdminPluginWrapper (+44 more)
...
Cohesion: 0.08
Nodes (33): args, buildContracts(), ChokidarModule, rootDir, setupWatcher(), watch, DataTableColumnHeader(), DataTableColumnHeaderProps (+25 more)
...
Cohesion: 0.12
Nodes (25): CompositeHooksConfig, CompositeHooksOptions, createCompositeHooks(), getOptionalHook(), MutationResult, QueryResult, createProcedureInvalidator(), ConflictWarningScope (+17 more)
...
Cohesion: 0.14
Nodes (12): orgRoleRules, PermissionModule, Module, PermissionRepository, Injectable, PermissionService, ctx, mockEngine (+4 more)

### Community 363 - "LocalInitializationService"
Cohesion: 0.07
Nodes (10): log, PostgresContainerService, PostgresContainerStartOptions, LocalInitializationService, SetupWizardApiModule, SetupWizardController, SetupWizardInitModule, SetupWizardOrpcModule (+2 more)
...
Cohesion: 0.15
Nodes (3): DetailedInputBuilder, isEmptyObjectSchema(), UnionSchema
...
Cohesion: 0.15
Nodes (16): domainEnvironmentVariablesSchema, ProjectRuntimeConfig, runtimeStoragePolicySchema, ServiceRuntimeConfig, parseCpuMillicores(), parseMemoryMb(), PROVIDER_TYPE_SET, PROVIDER_VALUES (+8 more)
...
Cohesion: 0.17
Nodes (13): Session, configureLayoutAuth(), createSessionLayout(), NextLayoutProps, IMPORTANT: The fallback must not use hooks that require context, IMPORTANT: We do NOT render <Component /> in the fallback because:, NOTE: We also do NOT render children in the fallback!, SESSION_QUERY_KEY (+5 more)
...
Cohesion: 0.29
Nodes (4): AppModule, OrchestratorService, SetupSubAppModule, runSubApp()
...
Cohesion: 0.20
Nodes (11): Props, createBaseConfig(), defaultConfig, createNextJsConfig(), defaultConfig, createNodeConfig(), defaultConfig, createReactConfig() (+3 more)
...
Cohesion: 0.26
Nodes (10): CaseFormat, convertCase(), ConvertedKeys, convertObjectKeys(), DEFAULT_CASE_CONFIG, KeyMappingFunction, toCamelCase(), toKebabCase() (+2 more)
...
Cohesion: 0.06
Nodes (44): CoreDockerModule, EventsModule, Global, Module, MeshCoreModule, Module, DockerCommonModule, Module (+36 more)
...
Cohesion: 0.17
Nodes (12): createPathBuilder(), convertURLSearchParamsToObject(), useSearchParams(), CoreRouteElements, createPathBuilder(), createRouteBuilder(), emptySchema, makeRoute() (+4 more)
...
Cohesion: 0.20
Nodes (6): DockerRuntimeActivityProjectorService, Injectable, DockerRuntimeActivityCategory, DockerRuntimeActivityEntity, DockerRuntimeActivitySeverity, DockerRuntimeActivityStatus
...
Cohesion: 0.12
Nodes (24): computeDurationLabel(), DashboardDeploymentsPage(), DeploymentSortKey, formatDate(), projectLabel(), severityVariant(), SortDirection, statusBadgeVariant() (+16 more)
...
Cohesion: 0.21
Nodes (10): DockerContainerLogsTab(), formatInputDateTimeToIso(), formatIsoToInputDateTime(), sanitizeContainerLogMessage(), LogsSearchInput(), LogsSearchInputProps, LogsViewer(), LogsViewerLine (+2 more)
...
Cohesion: 0.53
Nodes (4): main(), MeshOpenInternalBridgeInput, generateSpec(), AppContract
...
Cohesion: 0.05
Nodes (26): MigrateCommand, Command, Injectable, DEPLOYER_VERSION, __dirname, __filename, NodeStartupCheckCommand, PKG_PATH (+18 more)
...
### Community 655 - "@thallesp/nestjs-better-auth"
Cohesion: 0.50
...
### Community 783 - "AccessDeniedError"
Cohesion: 0.11
...
## Knowledge Gaps
- **6797 isolated node(s):** `AuthHookContext`, `NavItem`, `mainNavItems`, `adminNavItems`, `accountNavItems` (+6792 more)
...
- **Why does `vitest` connect `vitest` to `pagination.ts`, `Mesh Networking Contracts`, `test.controller.ts`, `sorting.ts`, `HTTP/Traefik Router Builder`, `Docker Container Inspection`, `cn`, `SystemMeshTopologyService`, `index.ts`, `index.ts`, `AuthCoreService`, `platform-domain.builder.ts`, `mesh-connection-registry.ts`, `service-dag.service.ts`, `DockerRuntimeRunnerService`, `DeploymentTriggerInput`, `DeploymentService`, `docker-entity-domain.service.ts`, `ProjectService`, `middlewares.ts`, `index.ts`, `build-tools.ts`, `node-startup-check.command.ts`, `permission-engine.ts`, `VariableRegistry`, `deployment-queue-lifecycle.service.ts`, `mesh-query-builder-types.ts`, `query-builder.test.ts`, `index.ts`, `ServiceDomainMappingRepository`, `InitializationService`, `index.ts`, `resource-graph.ts`, `search.ts`, `GlobalDatabaseService`, `github.module.ts`, `DeploymentMeshService`, `deployment.service.spec.ts`, `index.ts`, `route-builder.ts`, `AnalyticsService`, `contracts.ts`, `index.ts`, `AppLifecycleService`, `user.repository.ts`, `PushRepository`, `deployment-provider-builder-runner-state-machine.service.ts`, `ServiceService`, `compatibility.ts`, `index.ts`, `docker-runtime-stream-orchestrator.service.ts`, `setup-wizard.tsx`, `generate-hooks.ts`, `shared-api-runtime.ts`, `organization.repository.ts`, `traefik-config-builder.ts`, `index.ts`, `configuration-core.module.ts`, `utils.ts`, `DeploymentRepository`, `package.json`, `page.tsx`, `index.ts`, `index.ts`, `ApiKeyRepository`, `project.module.ts`, `types.ts`, `DeploymentQueueProcessor`, `index.ts`, `service.schema.ts`, `mesh-filter.ts`, `index.ts`, `ProviderSchemaService`, `domain.module.ts`, `utils.test.ts`, `index.ts`, `SystemMeshConfigService`, `mesh-subscription-manager.ts`, `mesh-doc-compliance-matrix.e2e-spec.ts`, `load-balancer.service.ts`, `auth-core.service.ts`, `configuration-resolver.service.ts`, `rule-validator.ts`, `template.schema.exhaustive.test.ts`, `permission.repository.ts`, `devDependencies`, `context-menu.tsx`, `development-session.ts`, `LocalEventOutboxDispatcherService`, `load-balancer.controller.ts`, `DependencyTemplateConfig`, `fleet-rollback.service.ts`, `package.json`, `filtering.ts`, `drift-reconciliation.service.ts`, `DockerRuntimeActivityProjectorService`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `isRecord()` connect `isRecord` to `TraefikSyncService`, `Docker Container Inspection`, `Mesh Core & Orchestration`, `SystemMeshConfigService`, `DockerRuntimeEvent`, `generate-hooks.ts`, `Docker Runtime Activity Projection`, `Mesh Cluster Repository`, `Deployment Pipeline Service`, `page.tsx`, `toolbar.tsx`, `DockerContainerRuntimeService`, `mesh-connection-registry.ts`, `page.tsx`, `DeploymentTriggerInput`, `page.tsx`, `docker.repository.ts`, `docker-entity-domain.service.ts`, `index.ts`, `docker-containers-orchestrator.service.ts`, `ProjectService`, `index.ts`, `DeploymentRepository`, `index.ts`, `node-startup-check.command.ts`, `peerDependencies`, `VariableRegistry`, `place-autocomplete.tsx`, `page.tsx`, `index.ts`, `core-event-sync.service.ts`, `route-method-meta.ts`, `page.tsx`, `index.ts`, `DockerRepository`, `makeRoute.tsx`, `InitializationService`, `isObjectLike`, `index.ts`, `GlobalDatabaseService`, `hooks.ts`, `github.module.ts`, `rule-validator.ts`, `server.tsx`, `types.ts`, `MeshControlEnvelope`, `standard-schema-helpers.ts`, `index.ts`, `deployment.ts`, `MeshTrustStrictModeService`, `data-table.tsx`, `index.ts`, `error`, `.error`, `index.ts`, `DockerRuntimeActivityProjectorService`, `ServiceService`, `drizzle-filter.utils.ts`, `runtime-configuration-accessor.ts`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `requireAuth()` connect `requireAuth` to `AnalyticsService`, `ServiceDomainMappingRepository`, `test.controller.ts`, `docker-entity-domain.service.ts`, `TestController`, `ProjectService`, `middlewares.ts`, `AppLifecycleService`, `ProviderSchemaService`, `user.repository.ts`, `PushRepository`, `index.ts`, `organization.repository.ts`, `ServiceService`, `app-error.ts`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **What connects `AuthHookContext`, `NavItem`, `mainNavItems` to the rest of the system?**
