...
import { useDeploymentStore } from '@/state/deploymentStore'

export default function DashboardPage() {
  const projects = useProjectStore((state) => state.projects)
  const globalDeployments = useDeploymentStore((state) => state.globalDeployments)
  const activeDeployments = useDeploymentStore((state) => state.getActiveDeployments())
