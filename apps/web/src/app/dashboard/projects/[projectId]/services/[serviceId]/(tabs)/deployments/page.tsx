...
export default function ServiceDeploymentsPage({ params }: ServiceDeploymentsPageProps) {
  const { data: deploymentsData, isLoading } = useDeployments({ 
    serviceId: params.serviceId 
  })
  const deployments = deploymentsData?.deployments || []
  const { triggerDeployment, isLoading: deploymentLoading } = useDeploymentActions()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={handleTriggerDeployment} disabled={deploymentLoading.trigger}>
