...
import { Terminal, Download, Pause, Play, RotateCcw, Search, Calendar } from 'lucide-react'
...
export default function ServiceLogsClient() {
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Info entries</p>
          </CardContent>
        </Card>
      </div>
    </div>
