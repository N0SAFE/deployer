...
export default function ServiceEnvironmentConfigPage({ params }: ServiceEnvironmentConfigProps) {
  ...
  const [environmentVariables, setEnvironmentVariables] = useState<EnvironmentVariable[]>([
    { key: 'NODE_ENV', value: 'production', isSecret: false, environment: 'production' },
    { key: 'DATABASE_URL', value: 'postgresql://...', isSecret: true, environment: 'production' },
    { key: 'API_KEY', value: 'sk-...', isSecret: true, environment: 'production' },
    { key: 'NODE_ENV', value: 'staging', isSecret: false, environment: 'staging' },
    { key: 'DATABASE_URL', value: 'postgresql://staging...', isSecret: true, environment: 'staging' },
    { key: 'NODE_ENV', value: 'development', isSecret: false, environment: 'development' },
    { key: 'DEBUG', value: 'true', isSecret: false, environment: 'development' },
  ])
  ...
  const addVariable = () => {
    if (newVariable.key && newVariable.value) {
      setEnvironmentVariables(prev => [...prev, {
        ...newVariable,
  ...
  const deleteVariable = (key: string) => {
    setEnvironmentVariables(prev => 
      prev.filter(v => !(v.key === key && v.environment === activeEnvironment))
    )
  }

  const currentEnvironmentVars = environmentVariables.filter(v => v.environment === activeEnvironment)
            ...
            <TabsContent value="production" className="space-y-4">
              ...
              {currentEnvironmentVars.length === 0 ? (
                ...
                <div className="space-y-3">
                  {currentEnvironmentVars.map((variable, index) => (
