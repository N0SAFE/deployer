...
interface ResourcesConfigurationClientProps {
  serviceId: string
}

export function ResourcesConfigurationClient({ serviceId }: ResourcesConfigurationClientProps) {
  ...
  // Extract resource limits from service data
  const resourceLimits = service?.resourceLimits || {}
  
  // Mock current resource usage - in production this would come from monitoring APIs
  const resourceUsage = {
    cpu: 45,
    memory: 68,
    storage: 32,
  ...
  const handleInputChange = (_value: string) => {
    // TODO: Implement save changes with ORPC
    console.log(`Resource configuration changed: ${_value}`)
  }
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input 
                id="storage-limit" 
                value={resourceLimits.storage || "10 GB"}
