...
<DocMeta source="docs/UNIFIED-HOOK-PATTERN.md, docs/QUERY-KEY-INVALIDATION-DESIGN.md" scope="supplemental" />

## Purpose

The web app’s data access layer is a **hook layer**, not component-level networking.
