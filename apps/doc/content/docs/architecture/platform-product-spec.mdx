...
- **Optional advanced path**: custom LB redirect/token model for specialized owner-aware stream routing and diagnostics

See [Load Balancer Architecture](/docs/deployment/load-balancer) only when enabling that optional advanced pattern.
