...
export class TraefikFileSystemService {
  ...
  constructor(
    ...
    const basePath = this.configService.get<string>('TRAEFIK_CONFIG_BASE_PATH') || '/app/traefik-configs';
    ...
    this.paths = {
      ...
      backupPath: this.configService.get<string>('TRAEFIK_BACKUP_PATH') || join(basePath, 'backups'),
    };
