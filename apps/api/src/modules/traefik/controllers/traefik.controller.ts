...
export class TraefikController {
    constructor(
        ...
        private readonly traefikAdapter: TraefikAdapter,
    ) { }
    ...
    validateServiceConfig() {
        return implement(traefikContract.validateServiceConfig).handler(async ({ input }) => {
            ...
            if (configContent) {
                const result = this.traefikValidationService.validateConfig(configContent);
                return this.traefikAdapter.adaptValidationResultToContract(result);
            }
            ...
            const result = this.traefikValidationService.validateConfig(storedConfig.configContent);
            return this.traefikAdapter.adaptValidationResultToContract(result);
        });
    }
}
