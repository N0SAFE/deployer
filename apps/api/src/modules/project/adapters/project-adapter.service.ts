...
export class ProjectAdapter {
    ...
    adaptProjectListToContract(
        data: { projects: typeof projects.$inferSelect[]; total: number }, 
        limit: number, 
        offset: number
    ): ProjectListContract {
    ...
    adaptCollaboratorsToContract(collaborators: typeof projectCollaborators.$inferSelect[]): ProjectCollaboratorsContract {
    ...
    adaptEnvironmentsToContract(envList: typeof environments.$inferSelect[]): ProjectEnvironmentsContract {
    ...
    private transformEnvironmentToContract(dbEnv: typeof environments.$inferSelect) {
        ...
        return {
            ...
            dynamicVariables: [],
            deploymentConfig,
            metadata: dbEnv.metadata ?? {},
            tags: dbEnv.metadata?.tags ?? [],
    ...
    adaptVariableTemplatesToContract(templates: typeof variableTemplates.$inferSelect[]): ProjectVariableTemplatesContract {
        return {
    ...
    adaptAllEnvironmentStatusesToContract(envList: typeof environments.$inferSelect[]): ProjectAllEnvironmentStatusesContract {
