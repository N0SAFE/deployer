...
export class ServiceController {
  ...
  create() {
    return implement(serviceContract.create).handler(async ({ input }) => {
      ...
      return {
        ...
        builder: newService.builder,
        providerConfig: newService.providerConfig,
        builderConfig: newService.builderConfig,
        // TODO: Map real traefik config once stored per-service
        traefikConfig: null,
  ...
  update() {
    return implement(serviceContract.update).handler(async ({ input }) => {
      ...
      if (input.builder !== undefined) updateData.builder = input.builder;
      if (input.providerConfig !== undefined) updateData.providerConfig = input.providerConfig;
      if (input.builderConfig !== undefined) updateData.builderConfig = input.builderConfig;
      ...
      return {
        ...
        builder: updatedService.builder,
        providerConfig: updatedService.providerConfig,
        builderConfig: updatedService.builderConfig,
        // TODO: Map real traefik config once stored per-service
        traefikConfig: null,
