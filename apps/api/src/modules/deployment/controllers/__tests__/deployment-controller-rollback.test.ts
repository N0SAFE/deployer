...
describe('DeploymentController - Rollback History Endpoints', () => {
  let mockCleanupService: {
    cleanupOldDeployments: Mock<(...args: unknown[]) => unknown>;
    previewCleanup: Mock<(...args: unknown[]) => unknown>;
  };
  ...
  describe('getRollbackHistory', () => {
    it('should return rollback history with limited deployments', () => {
  ...
  describe('previewCleanup', () => {
    it('should return preview without deleting', async () => {
      ...
      const result = await mockCleanupService.previewCleanup(serviceId) as typeof mockPreview;
  ...
  describe('triggerCleanup', () => {
    it('should successfully trigger cleanup', async () => {
      ...
      const result = await mockCleanupService.cleanupOldDeployments(serviceId) as typeof mockResult & { success?: boolean };
  ...
  describe('updateRetentionPolicy', () => {
    it('should update retention policy successfully', async () => {
      ...
      const updatedService = await mockServiceRepository.update(serviceId, {
        deploymentRetention: newPolicy,
      }) as typeof mockService & { deploymentRetention: typeof newPolicy };
    ...
    it('should merge partial updates with existing policy', () => {
