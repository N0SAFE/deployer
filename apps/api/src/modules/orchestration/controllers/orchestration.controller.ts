 ...
 * `OrchestrationOrpcController` (type-safe ORPC API).
 *
...
export class OrchestrationController {
    ...
    constructor() {
        this.logger.warn('OrchestrationController is deprecated and no longer exposes operational endpoints. Use OrchestrationOrpcController.');
    }
}
