...
describe('UserService', () => {
    ...
    describe('createUser', () => {
        it('should create a new user when email does not exist', async () => {
            const input = { name: 'John Doe', email: 'john@example.com', image: null };
    ...
    describe('update', () => {
        ...
        it('should update user with new email when no conflict', async () => {
            const input = { id: '1', email: 'jane@example.com' };
        ...
        it('should throw ConflictException when updating to existing email', async () => {
            const input = { id: '1', email: 'existing@example.com' };
            mockRepository.findById.mockResolvedValue(mockUser);
        ...
        it('should not check email conflict when email is same as current', async () => {
            const input = { id: '1', email: 'john@example.com', name: 'John Updated' };
