...
export class ProviderSchemaController {
  ...
  getAllProviders() {
    return implement(providerSchemaRouter.getAllProviders).handler(() => {
  ...
  getProviderSchema() {
    return implement(providerSchemaRouter.getProviderSchema).handler(({ input }) => {
  ...
  getCompatibleBuilders() {
    return implement(providerSchemaRouter.getCompatibleBuilders).handler(({ input }) => {
  ...
  getAllBuilders() {
    return implement(providerSchemaRouter.getAllBuilders).handler(() => {
      const builders = this.builderRegistry.getAllBuilders();
      return {
        builders,
        total: builders.length,
  ...
  getBuilderSchema() {
    return implement(providerSchemaRouter.getBuilderSchema).handler(({ input }) => {
  ...
  getCompatibleProviders() {
    return implement(providerSchemaRouter.getCompatibleProviders).handler(({ input }) => {
