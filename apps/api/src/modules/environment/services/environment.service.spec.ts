...
describe('EnvironmentService', () => {
    ...
    describe('createEnvironment', () => {
        it('should create a new environment when slug is unique', async () => {
            ...
            expect(mockRepository.createEnvironment).toHaveBeenCalledWith(expect.objectContaining({
                name: 'staging',
                slug: 'staging',
                type: 'staging',
                createdBy: 'user-1',
    ...
    describe('Environment Variables', () => {
        ...
        describe('resolveEnvironmentVariables', () => {
            ...
            it('should handle resolution errors', async () => {
                ...
                await service.resolveEnvironmentVariables('1');
                expect(mockRepository.updateEnvironmentVariable).toHaveBeenCalledWith(dynamicVariable.id, expect.objectContaining({
