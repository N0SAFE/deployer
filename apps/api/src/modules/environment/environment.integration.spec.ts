...
describe('Environment Module Integration Tests', () => {
    ...
    describe('Service-Repository Integration', () => {
        ...
        it('should handle database operations through service layer', () => {
    ...
    describe('Error Handling Integration', () => {
        it('should propagate database errors through service layer', () => {
    ...
    describe('Async Operations', () => {
        it('should handle async repository operations', () => {
