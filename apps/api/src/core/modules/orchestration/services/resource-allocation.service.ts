...
import type { ResourceUsage } from '@repo/api-contracts/modules/orchestration';
...
export class ResourceAllocationService {
    ...
    async checkResourceCapacity(projectId: string, environment: string, requestedResources: Partial<ResourceUsage>): Promise<ResourceCapacityCheck> {
        try {
    ...
    async setResourceQuotas(projectId: string, environment: string, quotas: ResourceQuota): Promise<void> {
        try {
    ...
    async getResourceAllocation(projectId: string, environment: string): Promise<ResourceAllocation | null> {
        try {
            const quotas = await this.getResourceQuotas(projectId, environment);
