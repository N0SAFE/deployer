...
import { GitHubModule } from '@/core/modules/git/github';
 ...
 * - CoreDomainModule: Multi-level domain management (organization → project → service)
...
@Module({
  imports: [
    ...
    CoreDomainModule, // Add before modules that need domain management
