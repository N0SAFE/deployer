...
describe('Variable System', () => {
  ...
  describe('VariableValidator', () => {
    ...
    it('should fail on missing required variables', () => {
      ...
      expect(result.errors?.at(0)?.message).toContain("Required variable 'host' is missing");
    });
    ...
    it('should warn on extra variables', () => {
      ...
      expect(result.warnings?.at(0)?.variable).toBe('extra');
    });
    ...
    it('should validate references in objects', () => {
      ...
      expect(errors?.at(0)?.variable).toBe('port');
    });
  });
  ...
  describe('VariableResolver', () => {
    ...
    it('should detect circular references', () => {
      ...
      }).toThrow(/Maximum recursion depth|Configuration validation failed/);
    });
  });
