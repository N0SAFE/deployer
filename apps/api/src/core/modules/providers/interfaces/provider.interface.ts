import { type TraefikConfigBuilder } from '@/core/modules/traefik/config-builder/builders';
...
export interface IDeploymentProvider {
  ...
  /**
   * Get the default Traefik configuration builder for this provider
   * 
   * @param options - Configuration options
   * @returns TraefikConfigBuilder instance with default configuration
   */
