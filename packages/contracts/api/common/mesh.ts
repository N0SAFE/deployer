...
export const meshResourceLookupInputSchema = z.object({
    organizationId: z.uuid().nullable().optional(),
    kind: meshResourceKindSchema,
    key: z.string().min(1),
...
export const meshQueuePartitionPlanInputSchema = z.object({
    organizationId: z.uuid().nullable().optional(),
...
export const meshQueueTransitionAppendInputSchema = z.object({
    organizationId: z.uuid().nullable().optional(),
    queue: z.string().min(1),
    partitionKey: z.string().min(1),
    jobId: z.uuid().nullable().optional(),
...
export const meshQueueTransitionAppendResultSchema = z.object({
    appended: z.boolean(),
    duplicate: z.boolean(),
...
export const meshQueueTransitionApplyResultSchema = z.object({
    applied: z.boolean(),
    duplicate: z.boolean(),
    reason: z.string().nullable(),
    entry: meshQueueTransitionLogEntrySchema,
...
export const meshTrustSecretKeySchema = z.object({
    keyId: z.string().min(1),
    algorithm: z.enum(["HS256"]),
    status: z.enum(["active", "previous"]),
...
export const meshDuplexStreamControlAckOutputSchema = z.object({
