...
export const deploymentPhaseSchema = z.enum([
    "queued", "pulling_source", "building", "copying_files",
    "creating_symlinks", "updating_routes", "health_check", "active", "failed",
]);
...
export const deploymentEnvironmentSchema = z.enum(["production", "staging", "preview", "development"]);
