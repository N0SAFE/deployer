...
export type BaseDomainStreamServiceSymbolized = {
  readonly [BASE_DOMAIN_STREAM_SERVICE_SYMBOL]: true;
}

export type DomainStreamServiceRegistryEntry = {
  streamDomain: string;
...
export type DomainStreamMergeRegisteredOptions = {
  domains?: string[];
