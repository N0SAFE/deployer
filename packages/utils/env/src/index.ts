...
export const apiEnvSchema = zod
    .object({
        ...
        GITHUB_APP_ID: zod.string().optional(),
        GITHUB_APP_PRIVATE_KEY: zod.string().optional(),
        GITHUB_APP_CLIENT_ID: zod.string().optional(),
        GITHUB_APP_CLIENT_SECRET: zod.string().optional(),
