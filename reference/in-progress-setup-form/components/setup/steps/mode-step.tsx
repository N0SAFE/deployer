...
import type { SetupMode } from "@/lib/setup/types"
import { useState } from "react"

type Props = {
  initialMode: SetupMode | null
  onContinue: (mode: SetupMode) => void
}

export function ModeStep({ initialMode, onContinue }: Props) {
  const [selected, setSelected] = useState<SetupMode | null>(initialMode)
